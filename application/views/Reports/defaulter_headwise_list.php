		...
		if( $('#cw').is(":checked") || $('#ac').is(":checked") )
		{
				...
				if(viewupto!='')
				{
					...
					if(classs!='')
					{
						...
						if(sec!='')
						{
							...
							$('#myTable').dataTable( {
								"ajax": {
									"url": '<?= base_url('Defaulter_headwise_list/defaulter_classwise'); ?>',
									"type": "POST",
						        ...
						        "bDestroy": true,
						         "ordering": false,
						          ...
						          buttons: [
										/* {
							                extend: 'printHtml5',
											title: 'Class Wise Defaulter List',
										...
										{
							                extend: 'pdfHtml5',
											title: 'Class Wise Defaulter List All Head',
			...
			else if( $('#ac').is(":checked") )
			{
				...
				if(viewupto!='')
				{
					...
					$('#myTable').dataTable( {
						"ajax": {
						"url": '<?= base_url('Defaulter_headwise_list_all/defaulter_allclass'); ?>',
						"type": "POST",
						"data": {viewupto:viewupto},
						},
						'order':[],
						"bDestroy": true,
						"ordering": false,
						...
						/* {
							...
							{
							    extend: 'excelHtml5',
								title: 'All Class Defaulter List',
