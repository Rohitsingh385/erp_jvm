                ...
                <div class="col-sm-3">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="Chasis" class="form-control" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="engineno" class="form-control" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Tax Paid Date:</label>
                      <input type="date" name="tpd" id="datepicker" class="form-control esi_limit" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Tax Paid Expiry Date:</label>
                      <input type="date" name="tped" class="form-control" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Fitness Date:</label>
                      <input type="date" name="fd" class="form-control esi_emp_rate" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="date" name="frd" class="form-control" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="date" name="pcd" class="form-control" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-sm-3">
                    <div class="form-group">
                      <label>Pollution Control Expiry Date:</label>
                      <input type="date" name="pced" class="form-control" autocomplete="off">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="vn" id="vn" class="form-control" value='-'>
                    </div>
                  </div>
...
<script>
  ...
  //         if (data == 1) {
  //           $('#vn').val("");
  //           Command: toastr["info"]("This Vehicle No Is Already Assigned Please Enter Another One!", "Warning")
