				...
				<section class="content">
					...
					<div class="row">
						<div class="form-group">
							<b><p style="font-size: 18px;">Assign Incharge</p></b>
							<div class="col-sm-4">
								<div class="box-body">
									<hr>
									<form method="post" class="form-inline" action="<?php echo base_url('Bus_incharge_entry/insert_data'); ?>">
										<div class="row">
											...
											<button type="submit" class="btn btn-primary">Add Bus Incharge</button>
								...
								<table class="table table-bordered" id="example">
									...
									<tbody>
										...
										?>
												<tr>
													<td><?php echo $i; ?></td>
													<td><?php if ($bus_data->Incharge_nm == null) {
															echo "N/A";
														} else {
															echo $bus_data->Incharge_nm;
														} ?></td>
													<td><?php if ($bus_data->Incharge_ph_no == null) {
															echo "N/A";
														} else {
															echo $bus_data->Incharge_ph_no;
														} ?></td>
