              ...
              <form role="form" action="<?php echo base_url('Add_bus_route/savedata'); ?>" method="post" id="createForm">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <p class="box-title" style="font-weight: bold;">Assign Route Stoppage Wise</p>
                    <hr>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" multiple="multiple" name="stoppage[]" id="stoppage" required="true" style="font-size: 10px;">
                      </select>
                    </div>
