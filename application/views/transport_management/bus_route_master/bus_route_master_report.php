...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Bus Route Master</a> <i class="fa fa-angle-right"></i> Report Bus Route</li>
</ol>
              ...
              <form role="form" action="<?php echo base_url('Add_bus_route/savedata'); ?>" method="post" id="createForm">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <p class="box-title" style="font-weight: bold;">Report Route Stoppage Wise</p><hr>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="stoppage" id="stoppage" onchange='load_data()'required="true">
...
function load_data(){
	...
	$.ajax({
		url: '<?php echo base_url('Add_bus_route/getallbusdetails_report'); ?>',
		data:{preference:preference,vehicleno:vehicleno,trip_id:trip_id,stoppage:stoppage},
		method:"post",
...
{
  var vehicleno = $('#vehicleno').val();
  var div_data = '<option value="">--Select--</option><option value="All">All</option>';
  if(vehicleno != '')
  {
    $.ajax({
