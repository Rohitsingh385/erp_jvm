<html>
	...
	<head>
		...
		<body>
			...
			<table width='100%'>
				<tr>
					<td><center><img src='<?=$schoolset[0]['SCHOOL_LOGO'];?>' class='img-responsive'></center></td>
					<td><h2><center><?=$schoolset[0]['School_Name'];?><br /><?=$schoolset[0]['School_Address'];?></center></h2></td>
				</tr>
			</table>
