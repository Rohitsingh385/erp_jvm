...
<div class='mainb' style="padding: 15px; background-color: white; border-top: 3px solid #5785c3;">
  <div class="row">
    <div class='col-sm-12'>
		...
		?>
		<form  method='post' action='<?php echo base_url('e_exam/AddQuestions/saveQuestion'); ?>' autocomplete='off' enctype='multipart/form-data'>
		<table class='table'>
			<tr>
				<th>Class</th>
				<td>
