   ...
   $schoolset	=$this->pawan->selectA('school_setting','*');
	if(!empty($stuList)){
		...
		<table class='table' width="100%" cellspacing="0">
			<tr>					
					<td style="background:#5785c3; color:#fff!important;border-left: 1px solid;border-bottom:1px solid"><img src='<?php echo base_url(); ?><?=$schoolset[0]['SCHOOL_LOGO'];?>' class='img-responsive'></td><td style="background:#5785c3; color:#fff!important;border-right: 1px solid;border-bottom:1px solid" colspan="3"><center style="font-size:30px"><strong><?=$schoolset[0]['School_Name'];?><br /><?=$schoolset[0]['School_Address'];?></strong><center></td>
					</tr>
					<tr>					
