 ...
 ?>
   ...
   <div class="table-responsive">
		 	<table class='table'>
		        ...
		        $Ans_image = (!empty($vals['img']))?$vals['img']:''
				?>
				
				<tr>
				
				<td style="border: 1px solid ;"><?=++$f;?></td>
				<td style="border: 1px solid ;width: 230px;"><?=$vals['question'];?><br/><span style="float:right;"><?php if($q_image){?><a href="<?=base_url().$q_image;?>" target="Blank"><img src="<?=base_url().$q_image;?>" style="width:50px;height:50px;float:right;"></a><?php } ?></span></td>
				<td style="border: 1px solid ;width: 450px;"><?=$vals['ans']?>
					<br/><span style="float:right;"><?php if($Ans_image){?><a href="<?=base_url().$Ans_image;?>" traget="_Blank"><img src="<?=base_url().$Ans_image;?>" style="width:150px;height:150px;float:right;"></a><?php } ?></span>
					</td>
