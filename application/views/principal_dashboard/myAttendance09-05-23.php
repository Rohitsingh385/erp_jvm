										...
										<td class="text-center">
										 ...
										 <td class="text-center">
                							<input type="hidden" name="in_times" value="<?php echo $value['attendance']['START_TIME']; ?>">
              								<span class="editable" contenteditable="true"><?php echo $value['attendance']['START_TIME']; ?></span>
            							</td>

            							<td class="text-center">
                							<input type="hidden" name="out_times" value="<?php echo $value['attendance']['STOP_TIME'] ?>">
                							<span class="editable" contenteditable="true"><?php echo $value['attendance']['STOP_TIME']; ?></span>
            							</td>

										<td class="text-center">
               								 <select class="form-control" name="attendance_statuses"
                  							  <?php if (strtotime($value['date']) < strtotime(date('Y-m-d'))) { echo 'disabled'; } ?>>
                   								 <option value="AB" <?php if ($attendance_status_by_date[$value['date']] == 'AB') echo 'selected'; ?>>Absent</option>
                   								 <option value="P"  <?php if ($attendance_status_by_date[$value['date']] == 'P') echo 'selected'; ?>>Present</option>
                							</select>
           								 </td>
