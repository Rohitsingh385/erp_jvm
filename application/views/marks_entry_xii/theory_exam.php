...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Theory Exam</a> <i class="fa fa-angle-right"></i></li>
</ol>
        ...
        <div class="col-sm-9">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <center>
                        <h4><b>
                                <div id="view_max_marks" style="display:none; background:red; color:#fff; border-radius:5px;"></div>
                            </b></h4>
                    </center>
                </div>
            </div>
...
<script>
    function classes(val) {
        $.post("<?php echo base_url('Marks_entry_xii/classess'); ?>", {
            val: val
        }, function(data) {
    ...
    function secc(val) {
        ...
        $.post("<?php echo base_url('Marks_entry_xii/section'); ?>", {
            val: val,
            Class_No: Class_No
        }, function(data) {
            $("#exm_typ").html(data);
    ...
    function exam_type(ExamCode) {
        ...
        $.post("<?php echo base_url('marks_entry_xii/subject'); ?>", {
            ExamCode: ExamCode,
            Class_No: Class_No,
            sec: sec,
            ExamMode: ExamMode
    ...
    function subjectt() {
        ...
        $.post("<?php echo base_url('Marks_entry_xii/stu_list'); ?>", {
            opt_code: opt_code,
            Class_No: Class_No,
            sec: sec,
            exm_code: exm_code,
    ...
    function marks(value) {
        ...
        if ((MaxMarks >= vall) || (vall == 'ab') || (vall == 'AB')) {
            ...
            var mxm = splt[2];
            $.post("<?php echo base_url('Marks_entry_xii/sv_nd_upd'); ?>", {
                adm_no: adm_no,
                exm_typ: exm_typ,
                subcode: subcode,
                classs: classs,
    ...
    function approve(Class_No, sec, sorting, exm_code, subcode, trm, opt_code) {
        $.ajax({
            url: "<?php echo base_url('Marks_entry_xii/verifyMarks'); ?>",
            type: "POST",
            data: {
                Class_No: Class_No,
                sec: sec,
