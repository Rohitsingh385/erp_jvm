      ...
      <div class="card">
        <div class="card-body">
          <form autocomplete='off' id='nur_form_edit' enctype='multipart/form-data'>
			...
			<div class='row'>
				<?php //echo '<pre>'; print_r($stuData); echo '</pre>';die;?>
				<div class='col-sm-4'>
				...
				<div class='col-sm-4'>
					<div class="form-group">
						...
						<input id='dob' type="text" value='<?php echo date('d-M-Y',strtotime($stuData[0]['dob'])); ?>' class="form-control datepicker" name='dob' required readonly>
					</div>
				</div>
				<div class='col-sm-4'>
					<div class="form-group">
				...
				<div class='col-sm-4'>
					<div class="form-group">
						...
						<select class="form-control" name='phy_challenged' required>
							<option value=''>Select</option>
							<option value='YES' <?php if($stuData[0]['phy_challenged'] == 'Y' || $stuData[0]['phy_challenged'] == 'YES'){ echo "selected"; }?>>YES</option>
							<option value='NO' <?php if($stuData[0]['phy_challenged'] == 'N' || $stuData[0]['phy_challenged'] == 'NO'){ echo "selected"; }?>>NO</option>
						</select>
					</div>
				</div>
				<div class='col-sm-4'>
			...
			<fieldset class="scheduler-border">
				<legend class="scheduler-border">PARENT'S DETAILS</legend>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_gov_job' required>
											<option value='YES' <?php if($stuData[0]['f_gov_job'] == 'Y' || $stuData[0]['f_gov_job'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['f_gov_job'] == 'N' || $stuData[0]['f_gov_job'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_jbo_transferable'>
										    <option value='YES' <?php if($stuData[0]['f_jbo_transferable'] == 'Y' || $stuData[0]['f_jbo_transferable'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['f_jbo_transferable'] == 'N' || $stuData[0]['f_jbo_transferable'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_alumini' onchange="alumini(this.value,'F')">
											<option value='YES' <?php if($stuData[0]['f_alumini'] == 'Y' || $stuData[0]['f_alumini'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['f_alumini'] == 'N' || $stuData[0]['f_alumini'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_gov_job'>
											<option value='YES' <?php if($stuData[0]['m_gov_job'] == 'Y' || $stuData[0]['m_gov_job'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['m_gov_job'] == 'N' || $stuData[0]['m_gov_job'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_jbo_transferable'>
										    <option value='YES' <?php if($stuData[0]['m_jbo_transferable'] == 'Y' || $stuData[0]['m_jbo_transferable'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['m_jbo_transferable'] == 'N' || $stuData[0]['m_jbo_transferable'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_alumini' onchange="alumini(this.value,'M')">
											<option value='YES' <?php if($stuData[0]['m_alumini'] == 'Y' || $stuData[0]['m_alumini'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='NO' <?php if($stuData[0]['m_alumini'] == 'N' || $stuData[0]['m_alumini'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
					...
					<div class='row'>
					    <div class='col-sm-6'>
					    <fieldset class="scheduler-border">
						<legend class="scheduler-border">BROTHER & SISTER <span style='font-size:12px;'>(Studying in this school)</span></legend>
						<div class='row'>
						<div class='col-sm-6'>
							<div class="form-group">
							...
							<div class='col-sm-6'>
								<div class="form-group">
									...
									<select class="form-control" name='single_parent' onchange='single_parents(this.value)'>
										<option value='YES' <?php if('Y' == $stuData[0]['single_parent'] || 'YES' == $stuData[0]['single_parent']) { echo "selected"; }?>>YES</option>
										<option value='NO' <?php if('N' == $stuData[0]['single_parent'] || 'NO' == $stuData[0]['single_parent']) { echo "selected"; }?>>NO</option>
									</select>
								</div>
							</div>
						...
						<div class='col-sm-6'>
							...
							<input type='radio' <?php if($stuData[0]['grand_parent'] != 4){ echo "checked"; } ?> name='grnd_prnt' value='Y' id='grnd_prnt' onclick="grnd_prntt('YES')"> YES 
							
							<input type='radio' <?php if($stuData[0]['grand_parent'] == 4){ echo "checked"; } ?> name='grnd_prnt' value='N' id='grnd_prnt' onclick="grnd_prntt('NO')"> NO 
						</div>
									...
									<?php
										foreach($grand_parent as $key => $val){
											...
											?>
												...
												if($key == $stuData[0]['grand_parent']){ echo "selected"; }?> > <?php echo $val; ?>
												</option>
											<?php
											}
										}
				...
				<div class='row'>
					<div class='col-sm-12'>
						<fieldset class="scheduler-border">
							...
							<?php } ?>
							<span style='color:red'>* <b>Note:- </b><i>(Cousins are not allowed)</i></span>
						</fieldset>		
					</div>
				</div>	
					...
					<div class='col-sm-6'>
						<fieldset class="scheduler-border" style='height:475px;'>
							...
							<div class='col-sm-6'>
								<div class="form-group">
									<label>Mobile <span>*</span></label>
									<input type="number" value="<?php echo $stuData[0]['mobile']; ?>" class="form-control" name='p_mobile' id='p_mobile' onkeypress="if(this.value.length==10) { return false;}" min='0' required onchange='no_validate(10,this)'>
								</div>
							</div>
							</div>
						</fieldset>	
	...
	function grnd_prntt(val) {
		if (val == 'YES') {
			...
			$("#grand_parent").html("<option value=''>Select</option><?php foreach ($grand_parent as $key => $val) {
																			if ($key != 4) { ?><option value='<?php echo $key; ?>' <?php if ($key == $stuData[0]['grand_parent']) {
																																												echo "selected";
																																											} ?>><?php echo $val; ?></option><?php }
																																																																		} ?>");
		} else {
			$("#grp_prnts").hide();
			$("#grand_parent").html("<?php foreach ($grand_parent as $key => $val) {
