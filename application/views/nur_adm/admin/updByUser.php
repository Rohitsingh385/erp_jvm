        ...
        <div class="card-body">
          <form autocomplete='off' id='nur_form_edit' enctype='multipart/form-data'>
			...
			<div class='row'>
				...
				<div class='col-sm-4'>
					<div class="form-group">
						<label>Date of Birth <span>*</span></label>(<i style='font-size:11px; color:#000;'>Should be 01-04-2019 to 31-03-2020</i>)
				...
				<div class='col-sm-4'>
					<div class="form-group">
						...
						<select class="form-control" name='phy_challenged' required>
							<option value=''>Select</option>
							<option value='Y' <?php if($stuData[0]['phy_challenged'] == 'Y'){ echo "selected"; }?>>YES</option>
							<option value='N' <?php if($stuData[0]['phy_challenged'] == 'N'){ echo "selected"; }?>>NO</option>
						</select>
					</div>
				</div>
				<div class='col-sm-4'>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_gov_job' required>
											<option value='Y' <?php if($stuData[0]['f_gov_job'] == 'Y' || $stuData[0]['f_gov_job'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['f_gov_job'] == 'N' || $stuData[0]['f_gov_job'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_jbo_transferable'>
										    <option value='Y' <?php if($stuData[0]['f_jbo_transferable'] == 'Y' || $stuData[0]['f_jbo_transferable'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['f_jbo_transferable'] == 'N' || $stuData[0]['f_jbo_transferable'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='f_alumini' onchange="alumini(this.value,'F')">
											<option value='Y' <?php if($stuData[0]['f_alumini'] == 'Y' || $stuData[0]['f_alumini'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['f_alumini'] == 'N' || $stuData[0]['f_alumini'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_gov_job'>
											<option value='Y' <?php if($stuData[0]['m_gov_job'] == 'Y' || $stuData[0]['m_gov_job'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['m_gov_job'] == 'N' || $stuData[0]['m_gov_job'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_jbo_transferable'>
										    <option value='Y' <?php if($stuData[0]['m_jbo_transferable'] == 'Y' || $stuData[0]['m_jbo_transferable'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['m_jbo_transferable'] == 'N' || $stuData[0]['m_jbo_transferable'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								...
								<div class='col-sm-6'>
									<div class="form-group">
										...
										<select class="form-control" name='m_alumini' onchange="alumini(this.value,'M')">
											<option value='Y' <?php if($stuData[0]['m_alumini'] == 'Y' || $stuData[0]['m_alumini'] == 'YES'){ echo "selected"; }?>>YES</option>
											<option value='N' <?php if($stuData[0]['m_alumini'] == 'N' || $stuData[0]['m_alumini'] == 'NO'){ echo "selected"; }?>>NO</option>
										</select>
									</div>
								</div>
								</div>
							...
							<div class='col-sm-6'>
								<div class="form-group">
									...
									<select class="form-control" name='single_parent' onchange='single_parents(this.value)'>
										<option value='Y' <?php if('YES' == $stuData[0]['single_parent'] || 'Y' == $stuData[0]['single_parent']) { echo "selected"; }?>>YES</option>
										<option value='N' <?php if('NO' == $stuData[0]['single_parent'] || 'N' == $stuData[0]['single_parent']) { echo "selected"; }?>>NO</option>
									</select>
								</div>
							</div>
