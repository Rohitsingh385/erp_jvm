...
?>
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Accounts Report</a> <i class="fa fa-angle-right"></i> Trial Balance (With Opening Balance in Separate Column)</li>
</ol>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="box box-primary">
                <form id="printForm" action="<?php echo base_url('accounts_report/trialbalancereport/printTrialBalanceReportSeparateColumn'); ?>" method="post" target="_blank">
                  <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <input type="text" name="date_from" class="form-control" value="<?php echo set_value('date_from','01-Apr-'.$start_year); ?>" required="" readonly="">
                          </div>
                        </div>
                        <div class="col-sm-4">
                          <div class="form-group">
                            <label>Date Upto :</label><span class="req"> *</span>
                            <input type="text" name="date_to" class="form-control datepicker2" value="<?php echo set_value('date_to','01-Apr-'.$start_year); ?>" required="">
                          </div>
                        </div>
                      </div>
                    </div><br>
