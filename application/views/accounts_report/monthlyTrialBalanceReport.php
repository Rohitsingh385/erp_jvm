...
?>
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Accounts Report</a> <i class="fa fa-angle-right"></i> Trial Balance (Monthly) </li>
</ol>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="box box-primary">
                <form id="printForm" action="<?php echo base_url('accounts_report/trialbalancereport/printTrialBalanceMonthlyReport'); ?>" method="post" target="_blank">
                  <div class="box-body">
