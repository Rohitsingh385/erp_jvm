  ...
  <div id="content">
    <div>
      <table style="width: 100%;" class="table">
        <thead>
          <tr>
            <th class="thead-color text-center th">SNo</th>
            <th class="thead-color th" style="padding-left: 5px;">PARTICULARS</th>
            <th class="thead-color th text-center">LEDGER<br>CODE</th>
            <th class="thead-color th text-center">O. BAL. AS ON<br><?php echo date('d-M-Y',strtotime($date_from)); ?><br>Rs.</th>
            <th class="thead-color th text-center">Dr.<br>TRAN. AMOUNT<br>Rs.</th>
            <th class="thead-color th text-center">Cr.<br>TRAN. AMOUNT<br>Rs.</th>
            <th class="thead-color th text-center">CLOSING BAL. AS ON<br><?php echo date('d-M-Y',strtotime($date_to)); ?><br>Rs.</th>
          </tr>
        </thead>
            ...
            <?php foreach ($reportList[$value['cat_code']] as $keys => $val) {  
              ...
              ?>
                <tr>
                  ...
                  <td class="text-right">
                    <?php if($val['OBal'] != 0){ 
                      echo number_format(abs($val['OBal']),2); 
                      echo ($val['DC']=='D')?' Dr.':' Cr.';                      
                    } ?>
                  </td>
                  <td class="text-right">
                  ...
                  <td class="text-right">
                    <?php 
                      $open_bal = ($val['DC']=='D')?$val['OBal']:'-'.$val['OBal'];
                      $closingbal = $open_bal+$final_bal;
                      echo number_format(abs($closingbal),2); 
                      echo ($closingbal>0)?' Dr.':' Cr.';
                     ?>
                  </td>
                </tr>
            <?php endif; } ?>
