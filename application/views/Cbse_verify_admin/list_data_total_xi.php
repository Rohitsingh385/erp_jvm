		  ...
		  <table id="example1" class="table table-striped">
			<thead>
				<tr>
					...
					<th><strong>Board Name</strong></th>
					<th><strong>Board Roll No.</strong></th>
					<th><strong>Board Passing Year</strong></th>
				...
				foreach($stuData as $key => $val){
					?>
						<tr>
							...
							<td><?php echo strtoupper($val['SUBJECT1']); ?></td>
							<td><?php echo strtoupper($val['SUBJECT2']); ?></td>
							<td><?php echo strtoupper($val['SUBJECT3']); ?></td>
							<td><?php echo strtoupper($val['SUBJECT4']); ?></td>
							<td><?php echo strtoupper($val['SUBJECT5']); ?></td>
							<td><?php echo strtoupper($val['lng']); ?></td>
							
							<td><?php echo strtoupper($val['bord_name']); ?></td>
							<td><?php echo strtoupper($val['bord_roll']); ?></td>
							<td><?php echo strtoupper($val['bord_year']); ?></td>
