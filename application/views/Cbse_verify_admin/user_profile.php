 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       CBSE REGISTRATION FORM VERIFICATION FOR CLASS IX
      </h1>
		 ...
		 <div class="row">
			...
			<div style="border:1px solid grey;padding:8px">
				...
				<div class='col-md-4 '>
					...
					<input type="radio" value='HINDI (002)'  name="Lng_ENG" <?php if($lng == 'HINDI (002)'){echo "checked";}?> id='hin'>&nbsp;&nbsp;HINDI (002) 
					&nbsp;&nbsp;<input type="radio" value='SANSKRIT (122)'  name="Lng_ENG" <?php if($lng == 'SANSKRIT (122)'){echo "checked";}?> <?php if($verify == 1){echo "disabled";}?> id='sns'>&nbsp;&nbsp;SANSKRIT (122)
				</div>
					</li>
					...
					<li>5 <input type="checkbox" value='SOCIAL SCIENCE (087)'  checked disabled>&nbsp;&nbsp; SOCIAL SCIENCE (087)</li>
						<li>6 <input type="checkbox" value='ADDITIONAL: IT (402)'  checked disabled>&nbsp;&nbsp; ADDITIONAL: IT (402)</li>
					</ul>
					</div>
					<div class='col-md-4'>
