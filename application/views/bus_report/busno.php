	...
	<form id="form" method="post">
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 col-lg-3 col-xl-3 form-group">
				<label>Bus No.</label>
				<select class="form-control" required name="stoppage_name">
			...
			<div class="col-md-3 col-sm-3 col-lg-3 col-xl-3 form-group">
				<label>Trip</label>
				<select class="form-control" required name="trip_name">
					<option value="">SELECT</option>
					<option value="All">ALL</option>
					...
					?>
							<option value="<?php echo $trip_data->TRIP_ID; ?>"><?php echo $trip_data->TRIP_NM; ?></option>
					<?php
						}
					}
					?>
				...
				<div class="col-md-3 col-sm-3 col-lg-3 col-xl-3 form-group">
				<label>Month</label>
				<select class="form-control" required name="month_name">
					<option value="">SELECT</option>
