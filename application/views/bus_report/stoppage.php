		...
		<div class="row">
			<div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 form-group">
				...
				<select class="form-control" required name="stoppage_name" onchange="bus_amt(this.value)">
					...
					?>
							<option value="<?php echo $stop_data->STOPNO; ?>"><?php echo $stop_data->STOPPAGE; ?></option>
					<?php
						}
					}
					?>
			...
			<div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 form-group">
				...
				<select class="form-control" required name="trip_name" onchange="bus_amt(this.value)">
