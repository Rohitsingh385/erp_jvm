...
<div class='mainb' style="padding: 15px; background-color: white; border-top: 3px solid #5785c3;font-size: 12px;">
    <div class="row">
        ...
        <div class="col-sm-3">
            <label>Class</label>
            <select class="form-control" id="classs" onchange='getGroup(this.value)'>
...
<script type="text/javascript">
    ...
    function getGroup(val) {
        $("#load").html('');
        $.ajax({
            url: "<?php echo base_url('Stu_list_code/getGroup'); ?>",
            type: "POST",
            data: {
                val: val
            },
    ...
    function getStu(val) {
        ...
        $.ajax({
            url: "<?php echo base_url('Stu_list_code/getStu_code'); ?>",
            type: "POST",
            data: {
                val: val,
                classs: classs,
