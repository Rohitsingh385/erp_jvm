        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-default" style="background: #3278ab !important;color: white;font-size: 13px">
                    <div class="panel-heading"><i class="fa fa-edit"></i> Employee Payroll VPF Deduction Bulk Updation</div>
                    <br />
...
<script type="text/javascript">
    ...
    function updateDeduction(column_name, emp_id) {
        ...
        $.ajax({
            url: '<?php echo base_url('bulk_updation/employeedeductionVPF/updateDeduction'); ?>',
            data: {
