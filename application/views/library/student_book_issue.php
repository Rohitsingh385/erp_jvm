			  ...
			  <div class="row">
				   <div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="adm_no" id="adm_no" onchange='admis_no(this.value)' required class='form-control'>
								</div>
							</div>
			...
			<div class="form-group" >
			  ...
			  <div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" name="accno" id="accno" onchange='acce_no(this.value)' required class='form-control'>
								</div>
							</div>
				<div class="col-sm-6">
				  <div class="form-group">
