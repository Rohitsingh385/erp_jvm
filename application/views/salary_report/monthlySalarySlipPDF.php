 ...
 <head>
   ...
   <style>
     ...
     .detailstables2 tr td,
     .detailstables2 tr th {
       border: none;
       font-size: 13px;
     }
 ...
 <body>
   <div class="row text-center">
     <button type="button" class="btn" id="btn" style="color: #fff;background-color: #007bff;border-color: #007bff;" onclick="printl()">PRINT</button>
   </div>
   <?php $cut = 0;
    $sno = 0;
    ...
    ?>
     <div id="content">
       <table style="width: 100%;border: none;font-size: 16px;">
         <tr>
           <td class="border-none" width="60px"><img src="<?php echo base_url($school_setting['SCHOOL_LOGO']); ?>" width="80px" height="80px"></td>
