       ...
       <table class="table">
         <thead>
           ...
           <tr>
             ...
             <th class="thead-color">Other<br>Deduct</th>
           ...
           <?php $increase = 1;
            ...
            foreach ($resultList as $key => $value) { ?>
             <tr>
               ...
               <td class="text-right"><?php echo number_format($value['actual_basic']);
                                      $grand_total_basic += $value['actual_basic']; ?></td>
               <td class="text-right"><?php echo number_format($value['basic_salary']);
                                      $grand_total_payable_basic += $value['basic_salary']; ?></td>
               <td class="text-right"><?php echo number_format($value['da_pay']);
                                      $grand_total_da += $value['da_pay']; ?></td>
               <td class="text-right"><?php echo number_format($value['hra_pay']);
                                      $grand_total_hra += $value['hra_pay']; ?></td>
               <td class="text-right"><?php echo number_format($value['ta_pay']);
                                      $grand_total_ta += $value['ta_pay']; ?></td>
               <td class="text-right"><?php echo number_format($value['fixed_allowance']);
                                      $grand_total_fixed_all += $value['fixed_allowance']; ?></td>
               <td class="text-right"><?php echo number_format($value['shift_allowance']);
                                      $grand_total_shift_all += $value['shift_allowance']; ?></td>
               <td class="text-right"><?php echo number_format($value['medical_reimbursement']);
                                      $grand_total_medical_reimb += $value['medical_reimbursement']; ?></td>
               <td class="text-right"><?php echo number_format($value['sh_rent']);
                                      $grand_total_sh_rent += $value['sh_rent']; ?></td>
               ...
               <td class="text-right"><?php echo number_format($value['arrear_basic']);
                                      $grand_total_arrear_basic += $value['arrear_basic']; ?></td>
               <td class="text-right"><?php echo number_format($value['arrear_da']);
                                      $grand_total_arrear_da += $value['arrear_da']; ?></td>
               <td class="text-right"><?php echo number_format($value['arrear_hra']);
                                      $grand_total_arrear_hra += $value['arrear_hra']; ?></td>
               <td class="text-right"><?php echo number_format($value['arrear_ta']);
                                      $grand_total_arrear_ta += $value['arrear_ta']; ?></td>
               <td class="text-right"><?php echo number_format($value['arrear_fixed_allow']);
                                      $grand_total_arrear_fixed_all += $value['arrear_fixed_allow']; ?></td>
               <td class="text-right"><?php echo number_format($value['arrear_shift_allow']);
                                      $grand_total_arrear_shift_all += $value['arrear_shift_allow']; ?></td>
               <td class="text-right"><?php echo number_format($value['gross_salary']);
                                      $grand_total_gross_payable += $value['gross_salary']; ?></td>
               <td class="text-right"><?php echo number_format($value['pf_own_deduct']);
                                      $grand_total_epf += $value['pf_own_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['vpf_deduct']);
                                      $grand_total_vpf += $value['vpf_deduct']; ?></td>
                <td class="text-right"><?php echo number_format($value['esi_deduct']); $grand_total_esic += $value['esi_deduct']; ?></td>                      
               <td class="text-right"><?php echo number_format($value['prof_tax']);
                                      $grand_total_prof_tax += $value['prof_tax']; ?></td>
               <td class="text-right"><?php echo number_format($value['lic']);
                                      $grand_total_lic += $value['lic']; ?></td>
               <td class="text-right"><?php echo number_format($value['hra_rent_deduct']);
                                      $grand_total_hra_rent += $value['hra_rent_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['hra_elect_deduct']);
                                      $grand_total_hra_elect += $value['hra_elect_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['hra_security_deduct']);
                                      $grand_total_hra_security += $value['hra_security_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['hra_garage_deduct']);
                                      $grand_total_hra_garage += $value['hra_garage_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['group_insurance_amt'], 2);
                                      $grand_total_group_insur += $value['group_insurance_amt']; ?></td>
               <td class="text-right"><?php echo number_format($value['staff_welfare_fund']);
                                      $grand_total_staff_welfare += $value['staff_welfare_fund']; ?></td>
               <td class="text-right"><?php echo number_format($value['tds_deduct']);
                                      $grand_total_tds += $value['tds_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['medical_deduct']);
                                      $grand_total_medical_dedu += $value['medical_deduct']; ?></td>
               <td class="text-right"><?php echo number_format($value['bus_deduction']);
                                      $grand_total_bus_dedu += $value['bus_deduction']; ?></td>
               <td class="text-right"><?php echo number_format($value['advance_salary_deduct']);
                                      $grand_total_advance_sal += $value['advance_salary_deduct']; ?></td>
                <td class="text-right"><?php echo number_format($value['other_deduction']); $grand_total_other_deduc += $value['other_deduction']; ?></td>
               <td class="text-right"><?php echo number_format($value['total_deduction'], 2);
                                      $grand_total_deduction += $value['total_deduction']; ?></td>
               <td class="text-right"><?php echo number_format($value['payable_amt'], 2);
                                      $grand_total_payable += $value['payable_amt']; ?></td>
