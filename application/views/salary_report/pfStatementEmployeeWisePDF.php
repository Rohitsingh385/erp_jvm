        ...
        <tbody>
          ...
          foreach ($payslipData as $key => $value) { ?>
            <tr>
              ...
              <td class="name text-right"><?php echo $epf_wages= $value['basic_salary']+$value['da_pay']+$value['arrear_basic']+$value['arrear_da']; ?></td>
              <td class="name text-right"><?php echo $value['pf_own_deduct']; ?></td>
              <td class="name text-right"><?php
                                          if ($value['basic_salary'] > 15000) {
                                            $eps_wages = "15000";
                                          } else {
                                            $eps_wages = $value['basic_salary'];
                                          }

                                          if ($value['pension_applied'] == 1) {
                                            echo $pension = round(($eps_wages * $value['pension_rate']) / 100);
                                          } else {
                                            echo $pension = 0;
                                          } ?>
          ...
          <?php
            ...
            $total_basic = $total_basic + $epf_wages;
