<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Admit Card Status</a> <i class="fa fa-angle-right"></i></li>
</ol>
	...
	<form id="form" method="post">
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 form-group">
				...
				<select class="form-control"  name="sec_name" id="sec_name">
...
<script>
	...
	event.preventDefault();
		$.ajax({
			url: "<?php echo base_url('Admit_card/find_details_admitcard_status'); ?>",
			type: "POST",
			data: $('#form').serialize(),
