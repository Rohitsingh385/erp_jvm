   ...
   <div class="col">
     <ul class="nav nav-tabs card-header-tabs" role="tablist" id="ul">
       <li class="nav-item active" id="li">
         <a class="nav-link text-center" aria-controls="tab1" aria-selected="true" data-toggle="tab" href="#tab1" role="tab" style="font-size: 18px;text-align:center;">Payroll Details</a>
         <!-- active class is an attribute of the <a> element! -->
       </li>
       <li class="nav-item">
         <a class="nav-link text-center" aria-controls="tab2" data-toggle="tab" href="#tab2" role="tab" style="font-size: 18px;text-align:center;">Employee Details</a>
       </li>
     </ul>

     <div class="tab-content">
       <div class="tab-pane fade in active cont" id="tab1">
                       ...
                       <div class="box-body">
                           ...
                           <div class="col-sm-3">
                             ...
                             <div class="form-group">
                               <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   <label>
                                     <input type="radio" name="contract_type" class="flat-red contract_type" value="Permanent" <?php if ($singleData['CONTRACT_TYPE'] == "Permanent") {
                                                                                                                                  echo "checked";
                                                                                                                                } ?>>
                                     Permanent
                                   </label>
                                   <label>
                                     <input type="radio" name="contract_type" class="flat-red contract_type" value="Contract" <?php if ($singleData['CONTRACT_TYPE'] == "Contract") {
                                                                                                                                echo "checked";
                                                                                                                              } ?>>
                                     Contract
                                   </label>
                            ...
                            ?>
                             <div class="col-sm-3">
                               <div class="form-group">
                                 ...
                                 <select class="form-control" name="level_no" id="level_no" onchange="getLevelYear()" disabled>
                                   <option value="">Select</option>
                                   <?php
                                    foreach ($level_no as $key => $value) { ?>
                                     <option value="<?php echo $value['level_no']; ?>" <?php if (set_value('level_no', $singleData['LEVEL_NO']) == $value['level_no']) {
                             ...
                             <div class="col-sm-3">
                               <div class="form-group">
                                 <label>Level Year</label>
                                 <select class="form-control" name="level_year" id="level_year" disabled onchange="getPay()"></select>
                         ...
                         <div class="row">
                           ...
                           <div class="col-sm-3">
                             <div class="form-group">
                               <label>TA Slab</label>
                               <select class="form-control ta_slab" name="ta_slab" id="ta_slab" disabled>
                                 <option value="">select</option>
                         ...
                         <div class="row">
                           ...
                           <div class="col-sm-3">
                             <div class="form-group">
                               ...
                               <select class="form-control hra_applied_field" name="quater_area" id="quater_area" onclick="qtr_area(this.value)" <?php if ($singleData['HRA_APP'] != 1) {
                                                                                                                                                    echo "disabled";
                                                                                                                                                  } ?>>
                                 <option value="">Select Quarter Area</option>
                         ...
                         <div class="row">
                           ...
                           <!-- <div class="col-sm-3">
                             <div class="form-group">
                               ...
                               <input type="text" name="electricity_rent" class="form-control hra_applied_field rent_amount electricity_rent" autocomplete="off" value="<?php //echo set_value('electricity_rent', 0); 
                                                                                                                                                                        ?>" disabled="" onkeyup="rateCalculation()">
                             </div>
                           </div> -->
                           <div class="col-sm-3">
                             <div class="form-group">
                     ...
                     <div class="box box-primary">
                       ...
                       <div class="box-body">
                         <div class="row" >
                           ...
                           <div class="col-sm-4 prev_pf_ac_no_div" hidden>
                             <div class="form-group">
                           ...
                           <div class="col-sm-4 pf_ac_no_div" hidden>
                             <div class="form-group">
 ...
 <script type="text/javascript">
   ...
   $('.contract_type').on('ifChanged', function(event) {
     if (this.value == 'Permanent') {
       $("#level_no").removeAttr("disabled");
       $("#level_year").removeAttr("disabled");
       $("#basic_pay").attr("readonly", "readonly");
     } else {
       $("#level_no").val('');
       $("#level_year").val('');
       $("#level_no").attr("disabled", "disabled");
       $("#level_year").attr("disabled", "disabled");
       $("#basic_pay").removeAttr("readonly");
     }
   });

   $('#level_no').on('change', function(event) {
   ...
   $('.ta_allowance_applied').on('ifChanged', function(event) {
     if (this.value == '1') {
      ...
      if ($("#level_no").val()=='1' || $("#level_no").val()=='2'){
        $(".ta_slab").val("1");
      }else if ($("#level_no").val()>='3' && $("#level_no").val()<='8')
      {
        $(".ta_slab").val("2");
      }else{
         $(".ta_slab").val("3");
