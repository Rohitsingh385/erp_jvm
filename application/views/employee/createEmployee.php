				  ...
				  <div class="row">
                   <div class="col-sm-3">
                     ...
                     <div class="form-group">
                       ...
                       <input type="text" name="emp_id" onblur="checkempid()" class="form-control" value="<?php echo set_value('emp_id'); ?>" id="emp_id">
...
function getTeachingType()
{
  ...
  else
  {
    $("#teaching_type").attr('disabled',"");
     ...
     $.ajax({
       url: "<?php echo base_url('employee/employee/checkEmpID_new'); ?>",
       data: {
         empid: empid
       },
       type: "POST",
       ...
       success: function(result) {
         ...
         if (result != 'true') {
           $.toast({
             heading: 'Error',
             text: 'Employee ID Already Allocated',
