...
<table class='table' border='1' cellspacing='0' id='example'>
	...
	<tr>
		...
		<th>Sanskrit Reading</th>
		<th>Sanskrit Written Work</th>
		<th>Sanskrit Grade</th>
		<th>Sanskrit Highest Marks</th>
			...
			foreach($getData as $key => $val){
				?>
					<tr>
						...
						<td><?php echo $val['S3_T1_READ']; ?></td>
						<td><?php echo $val['S3_T1_WW']; ?></td>
						<td><?php echo $val['S3_T1_GR']; ?></td>
						<td><?php echo $val['S3_T1_HM']; ?></td>
					...
					<tr>
						...
						<td><?php echo $val['S3_T2_READ']; ?></td>
						<td><?php echo $val['S3_T2_WW']; ?></td>
						<td><?php echo $val['S3_T2_GR']; ?></td>
						<td><?php echo $val['S3_T2_HM']; ?></td>
