    ...
    <div style="padding: 10px; background-color: white">
        <div class="row">
            <div class="col-md-5">
                ...
                ?>
                    <div class="alert alert-success" role="alert" id="msg" style="padding: 2px 0px;">
            ...
            <div class="col-md-2">
                <center><a href="<?php echo base_url('Student_details/view_student/' . $ID); ?>" class="btn btn-success" target="_blank">Print View</a></center>
            </div>
            ...
            <div class="col-md-2">
                <center>
                    <p class="btn btn-danger" onclick="deletestudent()">Delete Student</p>
                </center>
            </div>
            <div class='col-sm-1'>
                            ...
                            <div class="col-md-10 col-sm-10 col-lg-10">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="ad" class="form-control" readonly value="<?php echo  date('d-M-Y', strtotime($ADMISSION_DATE)); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
