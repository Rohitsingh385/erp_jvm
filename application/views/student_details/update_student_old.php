                        ...
                        <select name="first_subject" id="first_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code1) {
                              ?>
                              <option value="<?php echo $subject_code1->SubSName; ?>" <?php if($SUBJECT1==$subject_code1->SubSName) {echo "selected";} ?> ><?php echo $subject_code1->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="second_subject" id="second_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code2) {
                              ?>
                              <option value="<?php echo $subject_code2->SubSName; ?>" <?php if($SUBJECT2==$subject_code2->SubSName) {echo "selected";} ?>><?php echo $subject_code2->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="third_subject" id="third_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code3) {
                              ?>
                              <option value="<?php echo $subject_code3->SubSName; ?>" <?php if($SUBJECT3==$subject_code3->SubSName) {echo "selected";} ?>><?php echo $subject_code3->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="fourth_subject" id="fourth_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code4) {
                              ?>
                              <option value="<?php echo $subject_code4->SubSName; ?>" <?php if($SUBJECT4==$subject_code4->SubSName) {echo "selected";} ?> ><?php echo $subject_code4->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
                       ...
                       <select name="fifth_subject" id="fifth_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code5) {
                              ?>
                              <option value="<?php echo $subject_code5->SubSName; ?>" <?php if($SUBJECT5==$subject_code5->SubSName) {echo "selected";} ?> ><?php echo $subject_code5->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
                        ...
                        <select name="sixth_subject" id="sixth_subject" class="form-control">
                          ...
                          if($subject){
                            foreach ($subject as $subject_code6) {
                              ?>
                              <option value="<?php echo $subject_code6->SubSName; ?>" <?php if($SUBJECT6==$subject_code6->SubSName) {echo "selected";} ?> ><?php echo $subject_code6->SubName; ?></option>
                              <?php
                            }
                          }
                          ?>
