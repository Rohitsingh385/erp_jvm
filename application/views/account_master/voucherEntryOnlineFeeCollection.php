...
<ol class="breadcrumb">
   <li class="breadcrumb-item"><a href="#">Voucher Entry</a> <i class="fa fa-angle-right"></i> Receipt Voucher (Online Collection) </li>
</ol>
...
function getFeeData()
{
    ...
    else
    {
      ...
      $.ajax({
          url: "<?php echo base_url('account_master/voucherentryonlinefee/getTodaysFeeCollection'); ?>",
          type: "POST",
...
function getCollectionMode()
{
    ...
    else
    {
      var divdata;
      $.ajax({
          url: "<?php echo base_url('account_master/voucherentryonlinefee/getCollectionMode'); ?>",
          type: "POST",
          data: {date:date},
          dataType: 'json',
           beforeSend:function()
