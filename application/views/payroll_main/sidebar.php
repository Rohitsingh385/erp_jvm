			...
			<?php if (in_array('viewApplyLeave', permission_data) || in_array('viewLeaveApproval', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-dashboard" aria-hidden="true"></i><span> My Desk</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<li><a class='' href="<?php echo base_url('payroll/dashboard/myattendance'); ?>"> My Attendance In Time</a></li>
							<li><a class='' href="<?php echo base_url('payroll/dashboard/myattendance/attendance_outtime'); ?>"> My Attendance Out Time</a></li>
						
						

						<li><a class='' href="<?php echo base_url('library/TeacherBookIssue/teacher_adv_book_issue'); ?>">Advance Book Issue</a></li>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span> Human Resource </span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewDisabledEmpList', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('employee/employee/disabledEmployeeList'); ?>"> Super Annuated Employee List</a></li>
						<?php } ?>
					</ul>
				</li>
			<?php endif; ?>
			...
			<?php if (in_array('viewStudentMaster', permission_data) || in_array('viewScholarship', permission_data) || in_array('viewHouseMaster', permission_data) || in_array('viewCategoryMaster', permission_data) || in_array('viewWardType', permission_data) || in_array('viewReligion', permission_data) || in_array('viewStudentRecordKeeping', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span> Student Information</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewStudentMaster', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Adm_stu/stu_details'); ?>">Online Registered Student</a></li>
						<?php } ?>
			...
			<?php if (in_array('viewDailyAttendance', permission_data) || in_array('viewDailyAttenReport', permission_data) || in_array('viewMonthlyAttenReport', permission_data) || in_array('viewStuAttenType', permission_data) || in_array('viewStuAttenType', permission_data) || in_array('viewStuAttenType', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span>Student Attendance</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('ExamAtt_XI'); ?>">Attendance Entry XI-XII</a></li>
						<li><a class='' href="<?php echo base_url('ExamAtt_XI/att_report'); ?>">Attendance Report XI-XII</a></li>
			...
			<?php if (in_array('viewClassSubAllocation', permission_data) || in_array('viewStuSubAllocation', permission_data) || in_array('viewMainSubject', permission_data) || in_array('viewCoScholGrade', permission_data) || in_array('viewDisciplineGrade', permission_data) || in_array('viewDisciGradeSkill', permission_data) || in_array('viewRemarksAlloc', permission_data) || in_array('viewMaxMarks', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i><span> Examination</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (login_details['user_id'] == 'EMP0140') { ?>
							<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('Stu_list_code'); ?>">CODE</a></li>
						<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('Stu_list_code/code'); ?>">CODE Wise Report</a></li>
						<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('Marks_entry_xii'); ?>">Marks Entry(Theory Annual)</a></li>
						<?php } ?>
						...
						<?php if (in_array('viewClassSubAllocation', permission_data)) { ?>
							<li><a class='<?php //if($first_part == 'clswise_subj_allco'){ echo "active"; } 
											?>' href="<?php echo base_url('Teacher_master/clswise_subj_allco'); ?>">Class-Wise Subject Allocation
									<div class="clearfix"></div>
								</a></li>
						<?php } ?>
						...
						<?php } ?>
						<?php if (in_array('viewMaxMarks', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='<?php //if($first_part == 'max	_marks_allco'){ echo "active"; } 
						...
						<?php if (in_array('viewMainSubject', permission_data)) { ?>
							<li><a class='<?php //if($first_part == 'index'){ echo "active"; } 
											?>' href="<?php echo base_url('Marks_entry/index'); ?>">Marks Entry
									<div class="clearfix"></div>
								</a></li>
							<li id="menu-academico-avaliacoes"><a class='<?php //if($first_part == 'max	_marks_allco'){ echo "active"; } 
																			?>' href="<?php echo base_url('ExamAtt'); ?>">Attendance Entry</a></li>
						...
						<?php if (in_array('viewMainSubject', permission_data)) { ?>
							<li><a class='<?php if($first_part == 'index'){ echo "active"; } 
												?>' href="<?php echo base_url('marksentry/MarksClasses'); ?>">Main Subject Junior<div class="clearfix"></div></a></li>
						<?php } ?>
...
<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('perGrade/index'); ?>">Personality Assessment Entry</a></li>
						<?php } ?>
						<?php if (in_array('viewCoScholGrade', permission_data)) { ?>
						...
						<?php } ?>
<?php if (in_array('viewRemarksAlloc', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('Remarks_new/index'); ?>">Remarks Allocation</a></li>
						<?php } ?>

						<?php //if(in_array('viewRemarksAlloc', permission_data)){ 
						?>
						<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('cross_list/JuniorCrossList/index'); ?>">Junior Cross List</a></li>
						<?php //} 
						?>
						<?php //if(in_array('viewRemarksAlloc', permission_data)){ 
						?>
						...
						<?php //} 
						?>
						<li id="menu-academico-avaliacoes" ><a class='' href="<?php echo base_url('hall_ticket/index'); ?>">Exam Hall Pass</a></li>
					</ul>
				</li>
			<?php endif; ?>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-money" aria-hidden="true"></i><span> Payroll </span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						<?php if (in_array('addPFESI', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('payroll/master/pfesi/create'); ?>">Master PF ESI</a></li>
						<?php } ?>
						...
						<?php } ?>
<?php if (in_array('viewPFESI', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a class='' href="<?php echo base_url('payroll/master/sqtmaster'); ?>">View SQ. FT.</a></li>
						<?php } ?>
						...
						<?php } ?>
						<?php if (in_array('viewPayControl', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('punching/autopunching'); ?>">Auto Punching</a></li>
						<?php } ?>

						<?php if (in_array('editAllowanceBulk', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('bulk_updation/employeeallowance_bulk'); ?>"> Allowance Bulk</a></li>
						<?php } ?>

						<!----old <?php //if(in_array('editAllowanceBulk', permission_data)){ 
									?>
									     <li><a class='' href="<?php //echo base_url('bulk_updation/employeeallowance'); 
																?>"> Allowance Bulk</a></li>
									<? //php // } 
									?>--->

						<?php if (in_array('editDeductionBulk', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('bulk_updation/employeededuction_bulk'); ?>"> Deduction Bulk</a></li>
						<?php } ?>

						<?php if (in_array('editDeductionBulk', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('bulk_updation/employeedeductionLIC'); ?>"> Deduction LIC</a></li>
						<?php } ?>

						<?php if (in_array('editDeductionBulk', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('bulk_updation/EmployeedeductionVPF'); ?>"> Deduction VPF Bulk</a></li>
						<?php } ?>

						<?php if (in_array('editDeductionBulk', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('bulk_updation/EmployeedeductionTDS'); ?>"> Deduction TDS Bulk</a></li>
						<?php } ?>

						<?php //if(in_array('editDeductionBulk', permission_data)){ 
						?>
						<li><a class='' href="<?php echo base_url('bulk_updation/Arrear_bulk'); ?>"> Arrear Bulk</a></li>
						<?php //} 
						?>
						<!---<?php //if(in_array('editDeductionBulk', permission_data)){ 
								?>
									     <li><a class='' href="<?php //echo base_url('bulk_updation/employeededuction'); 
																?>"> Deduction Bulk</a></li>-->
						<?php //} 
						?>
			...
			<?php if (in_array('viewVehicleMaster', permission_data) || in_array('viewVehicleIncharge', permission_data) || in_array('viewBusStoppageMaster', permission_data) || in_array('viewAddBusTrip', permission_data) || in_array('viewDriverMaster', permission_data) || in_array('viewAddBusRoute', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-truck" aria-hidden="true"></i><span> Transport Master </span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewVehicleIncharge', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_incharge_entry/bus_incharge') ?>">Vehicle Incharge Master</a></li>
						<?php } ?>
						
						<?php if (in_array('viewBusStoppageMaster', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_incharge_entry/stoppage_cat_master') ?>">Group Stoppage Master</a></li>
						<?php } ?>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-truck" aria-hidden="true"></i><span> Transport Management </span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewAddBusRoute', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Add_bus_route/index') ?>">Add Bus Stoppage</a></li>
						<?php } ?>
						
						
						<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('student_transport/Bus_transport') ?>">Student Stoppage Allocation</a></li>
									 <?php  ?>
...
<?php if (in_array('viewVehicleMaster', permission_data) || in_array('viewVehicleIncharge', permission_data) || in_array('viewBusStoppageMaster', permission_data) || in_array('viewAddBusTrip', permission_data) || in_array('viewDriverMaster', permission_data) || in_array('viewAddBusRoute', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-file" aria-hidden="true"></i><span> Bus Reports </span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						
						<?php if (in_array('viewAddBusRoute', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/stoppage_wise') ?>">Stoppage Wise Report</a></li>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/busno_wise') ?>">Bus No Wise Report</a></li>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/student_busfacility') ?>">Student List Avail Bus Facility</a></li>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/stoppage_summary') ?>">Stoppage Wise Student Count</a></li>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/busno_summary') ?>">Bus No. Wise Student Count</a></li>

							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('Bus_report/busno_stu_details') ?>">Organisation Stoppage Stu. Wise List</a></li>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('student_transport/Bus_transport') ?>">Student Bus Transport</a></li>
			...
			<?php if (in_array('viewBankSalaryLetter', permission_data) || in_array('viewSalaryBill', permission_data) || in_array('viewMonthlyPFReport', permission_data) || in_array('viewPfEsiStatement', permission_data) || in_array('viewMonthlySalarySlip', permission_data) || in_array('viewEMployeeReport', permission_data) || in_array('viewMonthlyLeaveReport', permission_data) || in_array('viewMonthlyAttenReports', permission_data) || in_array('viewAllowanceReport', permission_data) || in_array('viewYearlySalaryReport', permission_data) || in_array('viewDeductionReport', permission_data)) : ?>
				<li id="menu-academico"><a href="#" title="Reports"><i class="fa fa-money" aria-hidden="true"></i><span> Salary Reports</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php } ?>
						<?php if (in_array('viewBankSalaryLetter', permission_data)) { ?>
							<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('salary_report/Consolidated_report'); ?>">Consolidated Report</a></li>
						<?php } ?>
						<?php if (in_array('viewBankSalaryLetter', permission_data)) { ?>
			...
			<?php if (in_array('viewHomework', permission_data) || in_array('viewUploadedHomeworkDetails', permission_data)) : ?>
				<!--<li id="menu-academico" ><a href="#"><i class="fa fa-clipboard"></i><span> Homework</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
								   <ul id="menu-academico-sub" >
								   	<?php if (in_array('viewHomework', permission_data)) : ?>
									 <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('homework/Homework') ?>">Add Homework</a></li>
									 <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('homework/HomeworkStatus') ?>">Homework Status</a></li>
									<?php endif; ?>
									<?php if (in_array('viewUploadedHomeworkDetails', permission_data)) : ?>
									 <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('homework/homeworkreport') ?>">Uploaded Homework Details</a></li>
									<?php endif; ?>
								  </ul>
								</li>-->
			...
			<?php if (in_array('viewFeeReports', permission_data) || in_array('viewFeeDefaulterList', permission_data) || in_array('viewFeeHeadWiseDefaulter', permission_data) || in_array('viewClassReport', permission_data) || in_array('viewOtherReport', permission_data) || in_array('viewAdmitCard', permission_data) || in_array('viewTermWiseReportCard', permission_data) || in_array('viewStudentReport', permission_data)) : ?>
				<li id="menu-academico"><a href="#" title="Reports"><i class="fa fa-file" aria-hidden="true"></i><span> Reports</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('ward_report/ward_report_emp'); ?>">Ward Category Report</a></li>
						<?php } ?>
						...
						<li><a class='' href="<?php echo base_url('report_card/CrossList/index'); ?>">Crosslist Report
									<div class="clearfix"></div>
								</a></li>

<li><a class='' href="<?php echo base_url('report_card/Topper_10/index'); ?>">Exam WiseTopper list
									<div class="clearfix"></div>
								</a></li>
<?php if (login_details['user_id'] == 'EMP0140'){ ?>
<li><a class='' href="<?php echo base_url('report_card/Remarks_report/index'); ?>">Remarks Report</span>
									<div class="clearfix"></div>
								</a></li>
...
<?php } ?>
							...
							<li><a class='' href="<?php echo base_url('report_card/Annual_report_card_classes'); ?>">Annual Report Card Junior</span>
									<div class="clearfix"></div>
								</a></li>


							<li><a class='' href="<?php echo base_url('student_report/exam_tabulation_new'); ?>">Exam Wise Tabulation Sheet</span>
									<div class="clearfix"></div>
								</a></li>

							<li><a class='' href="<?php echo base_url('report_card/Consolidated_report'); ?>">Consolidated Report</span>
									<div class="clearfix"></div>
								</a></li>
			...
			<?php if (in_array('viewTransferCertificate', permission_data) || in_array('viewCancelReprintTC', permission_data) || in_array('viewCharacterCertificate', permission_data) || in_array('viewBonafideCertificate', permission_data) || in_array('viewDOBCertificate', permission_data) || in_array('viewTutionFeeCertificate', permission_data) || in_array('viewFeePaidCertificate', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-book"></i><span> New Certificate (X & XII) </span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('studentcertificate/Issuetc') ?>">School Leaving Certificate</a></li>
						<li id="menu-academico-avaliacoes"><a href="<?php echo base_url('studentcertificate/Issuecharacter') ?>">Character Certificate</a></li>
				...
				<li id="menu-academico"><a href="#" title="Certificate"><i class="fa fa-address-card" aria-hidden="true"></i><span> Certificate</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewTutionFeeCertificate', permission_data)) { ?>
							<li><a class='' href="<?php echo base_url('Tution_fee_certificate/show_tution'); ?>">Tuition Fee Certificate</span>
									<div class="clearfix"></div>
								</a></li>
						<?php } ?>
			...
			?>
				<li id="menu-academico"><a href="#"><i class="fa fa-address-card" aria-hidden="true"></i><span> Inventory Master</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						...
						<?php if (in_array('viewItemMaster', permission_data)) { ?>
							<li id="menu-academico-avaliacoes">
								<a href="<?php echo base_url('acquisition/requisition'); ?>">Requisition</a>
							</li>
						<?php } ?>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-globe"></i><span> Bulk Updation</span> <span class="fa fa-angle-right" style="float: right"></span>
					...
					<ul id="menu-academico-sub">
						<?php if (in_array('viewEmployeeLeave', permission_data)) { ?>
							...
							<li id="menu-academico-avaliacoes">
								<a href="<?php echo base_url('bulk_updation/leaveDetails'); ?>">Leave Details</a>
							</li>
			...
			if (login_details['ROLE_ID'] == 6) { ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-clock-o"></i><span> Timetable</span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes">
			...
			<?php //endif; 
			?>
			<!---if(in_array('working', permission_data)): -->
			<?php if (login_details['user_id'] == 'EMP0238' || login_details['user_id'] == 'EMP0182' || login_details['user_id'] == 'EMP0224' || login_details['user_id'] == 'EMP0142' || login_details['user_id'] == 'EMP0177') : ?>
				<li id="menu-academico"><a href="<?php echo base_url('Cbse_verify_admin/cbse_verification'); ?>"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span> CBSE Verification</span>
						<div class="clearfix"></div>
					</a>
				</li>
			<?php endif; ?>
			...
			<?php if (in_array('working', permission_data)) : ?>
				<li id="menu-academico"><a href="#"><i class="fa fa-clock-o"></i><span> Time Table</span> <span class="fa fa-angle-right" style="float: right"></span>
						<div class="clearfix"></div>
					</a>
					<ul id="menu-academico-sub">
						<li id="menu-academico-avaliacoes">
