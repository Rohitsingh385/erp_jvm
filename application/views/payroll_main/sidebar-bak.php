							...
							<?php if(in_array('viewClassSubAllocation', permission_data) || in_array('viewStuSubAllocation', permission_data)|| in_array('viewMainSubject', permission_data)|| in_array('viewCoScholGrade', permission_data)|| in_array('viewDisciplineGrade', permission_data)||in_array('viewDisciGradeSkill', permission_data)|| in_array('viewRemarksAlloc', permission_data)|| in_array('viewMaxMarks', permission_data)): ?>
								<li id="menu-academico" ><a href="#"><i class="fa fa-pencil-square" aria-hidden="true"></i><span> Examination</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
								   ...
								   <li id="menu-academico-avaliacoes" ><a class='' href="<?php echo base_url('permission/PermissionMaxMarks'); ?>">Lock Exam</a></li>
									...
									<?php } ?>
								<?php if(in_array('viewMaxMarks', permission_data)){ ?>
										 <li id="menu-academico-avaliacoes" ><a class='<?php //if($first_part == 'max	_marks_allco'){ echo "active"; } ?>' href="<?php echo base_url('maxmarks/MaxmarksClasses'); ?>">Maximum Marks Allocation Junior</a></li>
									<?php } ?>
								 	<?php if(in_array('viewMainSubject', permission_data)){ ?>
								     	<li><a class='<?php //if($first_part == 'index'){ echo "active"; } ?>' href="<?php echo base_url('Marks_entry/index'); ?>">Marks Entry</span><div class="clearfix"></div></a></li>
 <li id="menu-academico-avaliacoes" ><a class='<?php //if($first_part == 'max	_marks_allco'){ echo "active"; } ?>' href="<?php echo base_url('ExamAtt'); ?>">Attendance Entry</a></li>
									<?php } ?>
									<?php if(in_array('viewMainSubject', permission_data)){ ?>
...
<li><a class='' href="<?php echo base_url('student_report/exam_tabulation_new'); ?>">Exam Wise Tabulation Sheet</span><div class="clearfix"></div></a></li>
...
<li id="menu-academico" ><a href="#"><i class="fa fa-book" ></i><span> New Certificate (X & XII) </span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
								   <ul id="menu-academico-sub" >
									 <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('studentcertificate/Issuetc') ?>">Transfer Certificate</a></li>
								   ...
								   <ul id="menu-academico-sub" >
									...
									<?php } ?>
								 	<?php if(in_array('viewTutionFeeCertificate', permission_data)){ ?>
										<li><a class='' href="<?php echo base_url('Tution_fee_certificate/show_tution'); ?>">Tuition Fee Certificate</span><div class="clearfix"></div></a></li>
									<?php } ?>
					...
					<?php if(login_details['user_id']=='EMP0238' || login_details['user_id']=='EMP0182' || login_details['user_id']=='EMP0224'|| login_details['user_id']=='EMP0142' || login_details['user_id']=='EMP0177'):?>
						<li id="menu-academico" ><a href="<?php echo base_url('Cbse_verify_admin/cbse_verification'); ?>"><i class="fa fa-calendar-check-o" aria-hidden="true"></i><span> CBSE Verification</span> <div class="clearfix"></div></a>
						</li>
					<?php endif; ?>
