                ...
                <div class="box-body">
                  ...
                  <div id="printableArea">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered dataTable">
                        <thead style="background: #d2d6de;">
                          <tr>
                            ...
                            <th style="background: #337ab7 !important; color: white !important;">Sl.<br>No.</th>
                        ...
                        <tbody>
                          ...
                          foreach ($attendanceList as $key => $val) { ?>
                            ...
                            <tr>
                              ...
                              <td id="EMPID_<?php echo $val['EMPID']; ?>">
                                <?php echo $val['EMPID']; ?>
                                <input type="hidden" name="emp_idd" class="emp_idd" value="<?php echo $val['EMPID']; ?>">
                              </td>
                              ...
                              <td style='text-align:center;'>
                                ...
                                if (!empty($val['IN_TIME'])) {
                                  ...
                                  if ($inTime > $expectedInTime) {
                                    echo "<p style=background-color:#dc3545;color:white;> Late IN </p>";
                                  } elseif ($inTime < $expectedInTime) {
                                    echo  "<p style=background-color:#ffc107;color:white;> Before In </p>";
                                  } else {
                                    echo "<p style='background-color:green;color:White'>On time </p>";
                                  }
                                }
                                ?>
                              </td>
                              ...
                              <td style='text-align:center;'>
                                ...
                                if (!empty($val['OUT_TIME'])) {
                                  ...
                                  if ($inTime > $expectedInTime) {
                                    echo  "<p style = 'background-color:#ffc107;color:White;'> After OUT </p>";
                                  } elseif ($inTime < $expectedInTime) {
                                    echo "<p style = 'background-color:#dc3545;color:White;'> Before OUT </p>";
                                  } else {
                                    echo "<p style='background-color:green;color:White'>On time </p>";
                                  }
                                }
                              ...
                              <!-- <td class="contenteditable" contenteditable="true" onblur="updateAtt('ATT_STATUS','<?php //echo $val['EMPID'] 
                                                                                                                      ?>')" id="ATT_STATUS_<?php //echo $val['EMPID']; 
                                                                                                                                            ?>"><?php //echo $val['ATT_STATUS']; 
                                                                                                                                                                          ?></td> -->
                      ...
                      <center>
                        <a href="<?php echo base_url('punching/manualpunch/approve/' . $date); ?>" class="btn btn-success" id="a_right">Approve</a><br>
                      </center>
                    </div>
                  </div>
                </div>
