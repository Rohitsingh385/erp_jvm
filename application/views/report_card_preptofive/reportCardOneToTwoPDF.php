<html>
	...
	<!-- end header -->
		<table border='1' cellspacing='0'>
			...
			<?php
				foreach($subjData as $key1 => $val1){
					...
					?>
						<tr>
							<th style='text-align:left; background:#EAEDED;' colspan='5'><?php echo $val1['subjnm']; ?></th>
						</tr>
					<?php
					$skillDataT1 = $this->alam->reportCardOneToTwo($Class_No,$sec,$val,$subject_code);
		...
		<table style='width:100%' border='1' cellspacing='0'>
			...
			<?php
				foreach($subjDataGrd as $keyGrd => $valGrd){
					...
					<?php
					$skillDataGrad = $this->alam->reportCardOneToTwoGrade($Class_No,$sec,$val,$subject_codeGrd);
		...
		<table style='width:100%;' border='1' cellspacing='0'>
			...
			<tr>
				<td style='width:50%; height:100px;'><?php echo $remksT1; ?></td>
