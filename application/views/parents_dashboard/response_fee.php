...
<body>
    ...
    <?php 
		...
		$stuu_name = $student_details[0]->FIRST_NM;
		...
		$order_status = $stuData_fee[0]->F_Code;
  ...
  $amtinword="Rupees ".$result . "Only" /* . $points . " Paise" */;
		...
		?> 
			...
			<div class="table_heading">
				...
				<span class="telaff"> Affiliation No.: <?php echo $school_aff; ?></span><br>
				<span class="webemail" style='margin-left:60px'>Website: <?php echo $school_web; ?></span>
				<span class="webemail">  ||  Email: <?php echo $school_email; ?></span> <br>
            ...
            <table class="table_data" width="100%" border="1" class="trable_main">
                ...
                <tr class="tr_main">
                    <td colspan="2" style='text-align:left;padding:8px'><br/><p>
						If amount is deducted from your Bank Account, kindly wait for 48 hours for the payment to get settled.<br/>
							In case of any change/addition of Subject, extra amount will be charged.</p></td>
...
?>
			...
			<div class="table_heading">
				...
				<span class="webemail" style='margin-left:60px'>Website: <?php echo $school_web; ?></span><!-- <span class="webemail"> Email: <?php echo $school_email; ?></span> -->
	...
	<div style="margin-left: 10%;" id='prl'>
