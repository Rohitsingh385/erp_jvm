...
<div class="container">
	...
	<div class="row">
		...
		<tbody>
				...
				<tr>
					<td>3.</td>
					<td>ANSWER SHEET DISTRIBUTION : </td>
	...
	<div class="row">
		...
		<tbody>
				...
				<tr>
					<td>NOTE: </td>
					<td>If a student is found using unfair means during exam throgh Mobile Phoens, Smart Watch or any other gadgets or chits, even possessing these things in the exam hall will treated as unfair means. He/She will be awarded ZERO (0) in that subject and necessary disciplinary action will be taken.</td>
