			...
			<center>
					...
					<tr>
						<td>
							<center>
								...
								<b>
									<center><span style='font-size:14px !important;'>CBSE REGISTRATION FORM</span></center>
								</b>
							</center>
						</td>
					</tr>
				...
				<table class='table'>
					<tr>
						...
						<td><?php echo $allData[0]['SName']; ?></td>
					</tr>
					<tr>
						<th>Father's Name:</th>
					...
					<!--<tr style='background:#FADBD8'>
						<th>Username:</th>
						<td><?php //echo $allData[0]['id']."/2022"; 
							?></td>
					</tr>
					<tr style='background:#FADBD8'>
						<th>Password:</th>
						<td><?php //echo $allData[0]['mobile']; 
							?></td>
					</tr>-->
					<tr>
						<td colspan='2'>Registration charge:- <?php echo $allData[0]['Registration_Charges']; ?></td>
					</tr>
					<tr>
						<td colspan='2'>ID card + Photograph + Processing Charge:- <?php echo $allData[0]['Processing_ICard_Charges']; ?></td>
					</tr>
					<tr>
						<td colspan='2'><span style='color:#fff; background:red; border-radius:2px; padding:3px; font-size:12px;'>Payment of Rs. <?php echo $allData[0]['Registration_Charges'] + $allData[0]['Processing_ICard_Charges']; ?>.00</span></td>
					</tr>
				</table>
				<a href='<?php echo base_url('parent_dashboard/Cbse_Reg/payment_new/Payment_x'); ?>' class='btn btn-success form-control'>Pay Now</a>
			</center>
