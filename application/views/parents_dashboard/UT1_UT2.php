  ...
  <div class="content-wrapper container" style='background-color:#e6faff; padding:20px; border:1px solid #bfbfbf'>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
			<center>
				<img src="https://micaeduco.co.in/ERP/ASSETS/school_logo/jvm.png" height="150px">
				<h2>JAWAHAR VIDYA MANDIR</h2>
				<h4>Shyamali Colony, Doranda, Ranchi-834002</h4>
				<h5>Affiliated to CBSE, New Delhi</h5>
				<h5>ACADEMIC SESSION: 2023-2024</h5>
			</center>
          <div class="row">
		<br/><br/>
			<div class='col-md-12 col-sm-12 col-lg-12'>
				<div class='row'>
					<div class='col-md-6' style='background-color:#e6faff'>
						<h4><center>STUDENT DETAILS</center></h4>
						<hr/>
						<table class='table'>
							<tr><td><strong>Adm. No.:</strong></td><td><?php echo $adm;?></td></tr>
							<tr><td><strong>Student Name:</strong></td><td><?php echo $name;?></td></tr>
							<tr><td><strong>Father's Name:</strong></td><td><?php echo $FATHER_NM;?></td></tr>
							<tr><td><strong>Mother's Name:</strong></td><td><?php echo $MOTHER_NM;?></td></tr>
					...
					<div class='col-md-6' >
						<h4><center>UT-1 and UT-2 MARKS</center></h4>
						<hr/>
				<table class='table'>
					<tr style='color:white; background-color:#00ace6'>
					<th>Subject Name</th><th>Marks<br/>(UT-I)</th><th>Marks<br/>(UT-2)</th>
						</tr>
					<?php
					//echo "Subjects:";
					//echo '<br/>';
					...
					?>
							<tr>
								<td><strong><?php echo $key['SubName'];?></strong></td>
								<td><?php echo $key['M2'];?></td>
								<td><?php echo $key['mo_pt1'];?></td>
		...
		<center><span>This is system generated Marksheet hence, requires no signature.</span></center>
		<br/>
