  ...
  <div class="content-wrapper container" style='background-color:#e6faff; padding:20px; border:1px solid #bfbfbf'>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
			<center>
				<img src="http://micaeduco.co.in/erp/assets/school_logo/jvm.png" height="150px">
				<h2>JAWAHAR VIDYA MANDIR</h2>
				<h4>Shyamali Colony, Doranda, Ranchi-834002</h4>
				<h5>Affiliated to CBSE, New Delhi</h5>
				<h5>ACADEMIC SESSION: 2022-2023</h5>
		...
		<br/><br/>
			<div class='col-md-12 col-sm-12 col-lg-12'>
				<div class='row'>
					...
					<div class='col-md-6' >
						<h4>PERIODIC TEST-1 MARKS SHEET</h4>
						<hr/>
				<table class='table'>
		...
		<center><strong>* This is a system generated report hence does not require signature</strong></center>
		<br/>
