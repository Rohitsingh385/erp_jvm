	...
	<div class="col-md-12 col-lg-12 col-sm-12">
		<div class="row">
			<div class="four-grids">
				...
				<div class="col-md-3 four-grid">
					<a href="<?php echo base_url('Student_strength/category_count'); ?>">
					<div class="four-agileinfo">
						<div class="icon">
							<i class="fas fa-address-card" style="font-size:30px; color: #fff;"></i>
						</div>
						<div class="four-text">
							<h3>Category <br />Count</h3>
						</div>
					</div></a>
				</div>
				<div class="col-md-3 four-grid">
					<a href="<?php echo base_url('Student_strength/clsregistar'); ?>">
					<div class="four-agileinfo">
						<div class="icon">
							<i class="fas fa-address-card" style="font-size:30px; color: #fff;"></i>
						</div>
						<div class="four-text">
							<h3>Class <br />Registar</h3>
						</div>
					</div></a>
				</div>
				<!--<div class="col-md-3 four-grid">
