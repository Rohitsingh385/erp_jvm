            ...
            <div class="col-sm-8">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    ...
                    <button class="btn btn-black" type="button" data-keyboard="false" data-backdrop="static" data-toggle="modal" data-target="#copyAndCreateNewClassSec"><i class="fa fa-exchange" style="color:white !important;"></i> Copy &amp; Create New Class / Section </button>
                    <hr>
                  </div>
                  <!-- /.box-header -->
        ...
        <div class="modal-body">
          <div class="row"> 
            <div class="col-sm-4">
              <div class="form-group">
                <label>Class</label><span class="req"> *</span>
                <select class="form-control" name="class_id" id="class_id_copy_creation" onchange="getSubjectByClassSectionCode()" required="">
                  <option value="">Select Class - Section</option>
                  <?php foreach ($createdClassSection as $key => $value) { ?>
