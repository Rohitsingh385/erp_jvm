					...
					<!--<div class="col-sm-6 logo-w3-agile">
					   <h1 style="font-size: 16px;font-weight: bold;"><a href="<?php //echo base_url(); ?>"><?php //echo role_details['NAME'].' Dashboard ('. schoolData['short_nm'].' '.schoolData['School_Session'].')'; ?></a></h1>
						...
						<div class="col-sm-12 profile_details">
                                <ul style='float:left;line-height:35px; margin-top:5px' class='role'>
                                 <li>
									  <a style='color:#fff;' href="<?php echo base_url(); ?>"><?php echo role_details['NAME'].' Dashboard ('. schoolData['short_nm'].' '.schoolData['School_Session'].')'; ?>
									  </a>
								 </li> 				
                                </ul>						
								<ul>
