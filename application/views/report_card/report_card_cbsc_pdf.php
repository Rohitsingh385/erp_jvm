			...
			foreach($result as $key => $data){
				...
				?>
				  ...
				  <table class='table'>
					...
					<tr>
					  <th>Father's Name :</th>
					  <td colspan='4'><?php echo $data['FATHER_NM']; ?></td>
					  <th>Attendance :</th>
					  <td colspan='1'><?php //echo $data['FATHER_NM']; ?></td>
					</tr>
				  ...
				  <table class='table' border='0.5' style='border-top:0.5px solid #000;'>
				    <tr>
					  ...
					  <th colspan='5'><center><?php if($trm == 1){echo "FIRST ";}else{echo "SECOND ";}?>TERMINAL EXAMINATION</center></th>
					</tr>
					<tr>
					  <th style="width:300px;">Subject Name</th>
						<?php
							...
							{
								?><th><center> PERIODIC TEST (10)</center></th>
						<?php }?>
						
						<?php
							if($data['DISP_CLASS'] =='III'||$data['DISP_CLASS'] =='IV'||$data['DISP_CLASS'] =='V'){?>
								<th><center> FORTNIGHTLY TEST (20)</center></th>
							<?php }
							else
							{
								?><th><center> FORTNIGHTLY TEST (10)</center></th>
						<?php }?>
					...
					<tr>
					 ...
					 <td>
					  <?php if($subject['opt_code'] != 1) { ?>
					   <center><?php echo $subject['marks']['REVISION-TEST-I'] / 2; ?></center>
					  <?php } ?> 
					  </td>
					  ...
					  {					
						echo $subject['marks']['marks_obtained'].'/50';
					  }
					 ?></center>  
						<?php
					  } ?>
					  ...
					  <td><center>
						<?php 
							...
							else
							{
								...
								{
									$mo=$subject['marks']['marks_obtained']*2;
									$gradeData = $this->sumit->fetchSingleData('Grade,Qualitative_Norms','grademaster',"ORange >=$mo AND CRange <= $mo");
					...
					<tr>
					  <th>Grand Total is excluding I.T., G.K. & M. SC. Marks</th>
					...
					<tr>
					  <th></th>
					  <th colspan='3' style="text-align:right">Overall Percentage & Grade</th>
				  ...
				  <div class='row'>
				    <div class='col-xs-12'>
					  <table class='table' border='0.5' style='border-top:0.5px solid #000;'>
						...
						<tr>
								<th colspan='3'><center>CO-SCHOLASTIC AREA</center></th>
							</tr>
						
							<tr>
								<th><center>MUSIC</center></th>
								<th><center>ART</center></th>
								<th><center>GAMES & SPORTS</center></th>
					...
					<?php
						...
						<?php }?>
							...
							if($data['DISP_CLASS'] =='III'||$data['DISP_CLASS'] =='IV'||$data['DISP_CLASS'] =='V'){?>
								<table class='table' border='0.5' style='border-top:0.5px solid #000;'>
							<tr>
								<th colspan='5'><center>INSTRUCTIONS: Grading Scale for Scholastic Areas</center></th>
							</tr>
				  ...
				  <div class='row'>
				    ...
				    <table class='table'>
					   ...
					   <tr>
						 <td class='sign'><center><br />Parent's Signature</center></td>
						 <td class='sign'><center><br />Class Teacher's Signature</center></td>
						 <td class='sign'><center><img src='assets/school_logo/sec_in_charge.png' ><br />Section In-charge's Signature</center></td>
						 <td class='sign'><center><img src='assets/school_logo/sjana2.png' ><br />Principal's Signature</center></td>
					  </tr>
