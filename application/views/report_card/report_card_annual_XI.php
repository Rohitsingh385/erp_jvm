	...
	<form id="stu_form" method="post" autocomplete='off'>
	 <table class="table" style='margin-top:-40px;'>
	    <tr>
		  ...
		  <td>
		    <select class="form-control" name='trm' id="trm" onchange="term(this.value)" style='display:none' readonly>
		  ...
		  <th>Round Off</th>
		  <td><input type="radio" name="round" value='1' checked></td>
		  
		  <th>No Round Off</th>
		  <td><input type="radio" name="round" value='2' ></td>
		</tr>
		<tr>
		  <td colspan='11'><br /></td>
		</tr>
...
$("#stu_form").on("submit", function (event) {
 ...
 function generate(){
	  ...
	  if(radioValue == 1){
		$.ajax({
		url: "<?php echo base_url('report_card/Report_card/make_report_card_annual_XI'); ?>",
		type: "POST",
		...
		success: function(data){
		  ...
		  if(classs == 12){
			   $.ajax({
				  url: "<?php echo base_url('report_card/tabulation/term1XTabulation'); ?>",
				  type: "POST",
				  data: $("#stu_form").serialize(),
				  success: function(data){
						$("#btnload").hide();
