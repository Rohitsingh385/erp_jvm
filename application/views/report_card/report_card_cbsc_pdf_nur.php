			...
			foreach($result as $key => $data){
				?>
				  ...
				  <table class='table'>
				    <tr>
					  <th>Admission No. :</th>
					  <td><input type="hidden" id='term' value='<?php echo $term; ?>'><?php echo $data['ADM_NO']; ?><input type='hidden' value='<?php echo $data['ADM_NO']; ?>' id='adm_<?php echo $j;?>'></td>
					  <th>Class-Sec:</th>
				  ...
				  <table class='table' border='1' style='border-top:2px solid #000;'>
				    <tr>
					  ...
					  <th colspan='2'><center><?php if($trm == 1){echo "FIRST ";}else{echo "SECOND ";}?>TERMINAL EXAMINATION</center></th>
					</tr>
					<tr>
...
<script>
	...
	for(var i=1; i<=lp; i++){
		...
		$.ajax({	
		 ...
		 data:{'value':ab,'idd':i,'admno':adm,'lp':lp,'term':term},
		 type:"POST",
