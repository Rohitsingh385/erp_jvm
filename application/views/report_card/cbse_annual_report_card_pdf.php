  ...
  <body>
	...
	<div class='row'>
		<div class="col-sm-3 col-xs-3"><br />
		  <img class="pull-right" src="<?php echo base_url($school_setting[0]->SCHOOL_LOGO); ?>" style="width:100px;height:100px;margin-right:50px">
		</div>
						...
						?>
						 <tr>
						   <td style='text-align:left;'><?php
								...
								echo $val4[$val2['subject_code']]['sub'];
...
$tot_mo += round($val5);					
						   ...
						   <?php
						     ...
						     if($round==1)
						     {
									$fin_tot_mo_tot += ($val2['opt_code'] != 1)?round($fin_tot_mo):0;
						     }else{
						     $fin_tot_mo_tot += ($val2['opt_code'] != 1)?($fin_tot_mo):0;	
						     }
	  ...
	  <tr>
		...
		<tr>
		  <td colspan='9' style='text-align:right'><b>Overall Percentage</b></td>
	    
	    <td><?php
			$grandTotT1T2 = $fin_tot_mo_tot/$cnt_opt;
		  $grandTotT1T2=round($grandTotT1T2,2);	
		  echo $grandTotT1T2;
	  ...
	  <table class='table' border='1'>
	    <tr>
		  <th style='text-align:center; font-size:15px;'>The grand total is excluding GK, MORAL SCIENCE and COMPUTER.</th>
	    </tr>
...
<br/>		
		<div class='col-sm-3 col-xs-3'><center><br /><b>PARENT<br/>SIGNATURE</b></center></div>
		<div class='col-sm-3 col-xs-3'><center><br /><b>CLASS TEACHER<br/>SIGNATURE</b></center></div>
		<div class='col-sm-3 col-xs-3'><center><br /><b>SECTION  INCHARGE<br/>SIGNATURE</b></center></div>
		<div class='col-sm-3 col-xs-3'>
			<!--<center><br /><img style='width:50px; position:absolute; bottom: 25px;'src='<?php //echo base_url($sign); ?>'></center>-->
			<center><br /><b>PRINCIPAL<br/>SIGNATURE</b></center>
		</div>
	</div>
	<!-- end signature -->
	</div>
