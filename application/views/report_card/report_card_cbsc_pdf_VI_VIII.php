			...
			<div style="border:5px solid #000; padding:10px;" id='dyn_<?php echo $j; ?>'>
				<table class='table1'>
					<tr>
						...
						<td>
							<center><span style='font-size:16px !important;'><b><?php echo $school_setting[0]->School_Name; ?></b></span><br />
				...
				<table class='table' border='1' style='font-size:10px! important;'>
					...
					foreach ($data['subject_nm'] as $key1 => $val1) {
						...
						$term2Tot = ($data['term2'][7][$key1]['M3'] + $data['term2'][5][$key1]['M4'] + round(($data['term2'][16][$key1]['M3'] + $data['term2'][17][$key1]['M3']) / 2, 0));
					...
					?>
						<tr>
							...
							?>
								<td colspan="2">
									<center><?php echo $data['term1'][1][$key1]['M4'] . ' / ' . $data['term1'][1][$key1]['M1']; ?></center>
								</td>
							...
							?>
								<td>
									<center><?php echo $data['term1'][4][$key1]['M4'] . ' / ' . $data['term1'][4][$key1]['M1']; ?></center>
								</td>
							<?php } else {
							?>
								<td>
							...
							?>
								<td>
									<center><?php echo ($data['term2'][16][$key1]['M4'] + $data['term2'][17][$key1]['M4']); ?></center>
								</td>

								<td>
									<center><?php echo round(($data['term2'][16][$key1]['M3'] + $data['term2'][17][$key1]['M3']) / 4, 0); ?></center>
								</td>
							...
							?>
								<td colspan="2">
									<center><?php echo $data['term2'][7][$key1]['M4'] . ' / ' . $data['term2'][7][$key1]['M1']; ?></center>
								</td>
							...
							?>
								<td>
									<center><?php echo $data['term2'][5][$key1]['M4'] . ' / ' . $data['term2'][5][$key1]['M1']; ?></center>
								</td>
							<?php } else {
							?>
								<td>
					...
					<tr>
						...
						if ($data['class'] == 'VIII') {
							...
							$this->alam->insert('temp_class_viii_rc', $save);
						}
						// end insert query for class viii
						?>
						<td>
							<?php
							foreach ($grademaster as $key => $grade) {
					...
					<tr>
						...
						<td colspan='12'></td>
						<td>
							<center>OVERALL PERCENTAGE </center>
						</td>
						<td>
				...
				<table border='1' class="table1"  style='border-top:2px solid #000;font-size:11px! important;width:100%'>
                    ...
                    <tr>
                        <td><?php echo '&nbsp;'.$data['termskill'][2]['grade'].'&nbsp;'; ?></td>
                        <td><?php echo '&nbsp;'.$data['termskill'][1]['grade'].'&nbsp;'; ?></td>
                        <td><?php echo '&nbsp;'.$data['termskill'][3]['grade'].'&nbsp;'; ?></td>
                    </tr>
                </table>
                <br />
                <br />
				...
				<div class='row'>
					<div class='col-sm-12' style='margin-top:-22px! important'>
						<table class='table' border='1' style='border-top:2px solid #000;font-size:11px! important;width:100%'>
							...
							<tr>
								<th style="width: 50% !important;height: 50px !important;">
									<b>MID TERM : </b>
								</th>
								<th style="width: 50% !important;height: 50px !important;">
									<b>END TERM : </b>
