            ...
            <div style="border:5px solid #000; padding:10px; display:none" id='dyn_<?php echo $j; ?>'>
                ...
                <table class='table' border='1' style='border-top:2px solid #000;'>
                    ...
                    <tr>
                        ...
                        <th>
                            <center> TERM - 1(100)</center>
                        </th>

                        <th>
                            <center> Theory(70)</center>
                        </th>

                        <th>
                            <center> Practical(30) </center>
                        </th>
                    ...
                    <?php foreach ($data['sub'] as $subject) { ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <?php
                                    if ($subject['marks']['theory'] < 23) {
                                        echo '<u>' . $subject['marks']['theory'] . '</u>';
                                    } else {
                            ...
                            <td>
                                <center>
                                    <?php if ($subject['marks']['practical'] < 10) {
                                        echo  '<u>' . $subject['marks']['practical'] . '</u>';
                                    } else {
                ...
                <div class='row'>
                    <div class='col-xs-12'>
                        <table class='table' border='1' style='border-top:2px solid #000;'>
                            ...
                            <tr>
                                <th>
                                    <center>* This is a system generated report hence does not require signature.</center>
                                </th>
                            </tr>
