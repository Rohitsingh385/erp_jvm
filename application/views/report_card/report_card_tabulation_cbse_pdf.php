<html>
  <head>
    ...
    #footer { position: fixed; right: 0px; bottom: 15px; text-align: right;}
  ...
  <body>
     <header id="header">
       <div style="text-align: center;">
        <span style="font-size: 20px;font-weight: bold;">JAWAHAR VIDYA MANDIR, SHYAMALI</span>
        <br><span>Shyamali Colony, Doranda, Ranchi-834002</span><br>
      </div>
