...
<br />
<form id="" target="_blank" method="post" action="<?php if($classs==5 || $classs==6 || $classs==7 ){
	echo base_url('report_card/report_card/generatePDF_annual_mdl');
}else{
	echo base_url('report_card/report_card/generatePDF_annual_junior');
}?>">
				...
				<td>
					<?php
						if($data->t2_report_card_status == 1){
							...
							?>
			<a download href='<?php echo base_url('report_card_annual/'.$adm.'.pdf'); ?>' class='btn btn-success btn-sm'> Download </a><?php
						}
					?>
				</td>
  			  </tr>
