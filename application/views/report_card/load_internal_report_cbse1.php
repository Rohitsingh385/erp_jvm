			...
			<tr>
				...
				<?php
					...
					foreach($subjectData as $key1 => $val1){
						...
						$se =  $this->alam->selectA('marks','admno,ExamC,SCode,M1,M2,M3',"admno='".$val['ADM_NO']."' AND Classes='".$val['CLASS']."' AND Sec='".$val['SEC']."' AND Term='TERM-2' AND SCode='".$val1['subject_code']."' AND ExamC='5'");
						...
						$pt    = ($round == 1)?round(($best1+$best2)):number_format(($best1+$best2),2);
						$outof = ($pt + $nbuk + $subE);
						$tot = ($pt + $subE);
						?>
