...
class Cancel_reprint extends MY_Controller{
	...
	public function duplicate_copy(){
		...
		}else if($period_day == "APR-"|| $period_day == "APR" || $period_day == "MAY-" || $period_day == "MAY" || $period_day=="JUN-" || $period_day=="JUN" || $period_day == "JUL-" || $period_day == "JUL" || $period_day == "AUG-" || $period_day == "AUG" || $period_day == "SEP-" || $period_day == "SEP" || $period_day == "OCT-" || $period_day == "OCT" || $period_day == "NOV-" || $period_day == "NOV" || $period_day == "DEC-" || $period_day == "DEC" || $period_day == "JAN-" || $period_day == "JAN" || $period_day == "FEB-" || $period_day == "FEB" || $period_day == "MAR-" || $period_day == "MAR-"){
