...
function bar128($text) { // Part 1, make list of widths
 ...
 //Part 2, Write rows
 $html="<table cellpadding=0 cellspacing=0 style='margin-left: 5px; margin: 8px;'><tr>"; 
 for($x=0;$x<strlen($w);$x+=2) // code 128 widths: black border, then white space
 $html .= "<td><div class=\"b128\" style=\"border-left-width:{$w[$x]};width:{$w[$x+1]}\"></div></td>"; 
 return "$html<tr><td colspan=".strlen($w)." style='padding-top:8px'><font  family=arial size=3><b>$text</b></td></tr></table>"; 
}
?>