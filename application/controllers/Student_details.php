...
class Student_details extends MY_Controller{
	...
	public function Student_master(){
		$data = $this->dbcon->select('student','STUDENTID,ADM_NO,DISP_CLASS,ROLL_NO,DISP_SEC,DISP_SEC,FATHER_NM,MOTHER_NM,FIRST_NM,C_MOBILE',"Student_Status='ACTIVE'");
	...
	public function view_student($id)
	{
		$data = $this->dbcon->show_student($id);
		$adm = $data[0]->ADMISSION_NO;
		$student_details = $this->dbcon->student_info($adm);
		...
		$this->load->view('student_details/student_view', $array);
		...
		$this->dompdf->render();
		$this->dompdf->stream("student_view.pdf", array("Attachment" => 0));
	}
