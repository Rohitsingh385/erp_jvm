...
class AddHomework extends MY_Controller {
	...
	public function delQuestion(){
		...
		$e_exam_questions_hw_id = $this->input->post('e_exam_questions_hw_id');
		$this->db->query("delete from e_exam_questions_hw_append where id='$id' AND e_exam_questions_hw_id='$e_exam_questions_hw_id'");
		echo '1';
	}
