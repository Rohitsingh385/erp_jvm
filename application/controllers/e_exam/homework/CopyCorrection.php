...
(SELECT COUNT(DISTINCT(admno)) FROM e_exam_answers_hw WHERE e_exam_answers_hw.class_no=e_exam_questions_hw.classes and e_exam_answers_hw.sec_no=e_exam_questions_hw.sec and e_exam_answers_hw.subj_id=e_exam_questions_hw.subject AND final_submit_status=1 AND e_exam_answers_hw.homework_id=e_exam_questions_hw.id)constusubmit,

(SELECT COUNT(DISTINCT(admno)) FROM e_exam_answers_hw WHERE e_exam_answers_hw.class_no=e_exam_questions_hw.classes and e_exam_answers_hw.sec_no=e_exam_questions_hw.sec and e_exam_answers_hw.subj_id=e_exam_questions_hw.subject AND teacher_final_copy_correction=2 AND e_exam_answers_hw.homework_id=e_exam_questions_hw.id)conteacsubmit,
	
(SELECT COUNT(DISTINCT(admno)) FROM e_exam_answers_hw WHERE e_exam_answers_hw.class_no=e_exam_questions_hw.classes and e_exam_answers_hw.sec_no=e_exam_questions_hw.sec and e_exam_answers_hw.subj_id=e_exam_questions_hw.subject AND teacher_final_copy_correction<>2 and  final_submit_status=1 AND e_exam_answers_hw.homework_id=e_exam_questions_hw.id)teachnotsubmit
