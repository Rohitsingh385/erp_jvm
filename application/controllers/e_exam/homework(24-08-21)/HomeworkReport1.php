  ...
  <div class="panel-body" style="background-color:white;">
	...
	<input type="button" value="Print" class="btn btn-success btn-sm" onclick="printDiv()"><br><br>
      ...
      <div class="table-responsive" id="GFG">
		...
		<tr>
				<td style='background:#5785c3; color:#fff!important;border-left: 1px solid;border-bottom: 1px solid;'><center><img src='<?php echo base_url(); ?><?=$schoolset[0]['SCHOOL_LOGO'];?>' style="width:100px; height:80px;" class='img-responsive'></center></td>
