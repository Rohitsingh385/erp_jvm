...
class Onparent_details extends MY_controller {
	...
	$User_Id='111';
	error_reporting(0);
	$workingKey='20CA315CF21F12A94C9FB150BA3A4C52';		//Working Key should be provided here.
		...
		for($i = 0; $i < $dataSize; $i++) 
	{
		...
		$array =     array('school_logo'=>$school_logo,'school_name'=>$school_name,'school_add'=>$school_add,'school_phone'=>$school_phone,'school_aff'=>$school_aff,'school_web'=>$school_web,'school_email'=>$school_email,'orderr_id'=>$orderr_id,'pay_amt'=>$on_amt,'order_status'=>$order_status,'adm_no'=>$admm,'rect_no'=>$ses,'merchant_param1'=>$merchant_param1);
