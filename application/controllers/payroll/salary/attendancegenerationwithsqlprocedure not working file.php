...
class Attendance_gen extends MY_Controller {
	...
	public function index(){
		...
		if(isset($_POST['search']))
		{
			...
			$weekend_date = implode(",", $all_weekend_date);
			...
			// foreach ($emp_data as $key => $value) {
				...
				$this->attendance->generateMonthlyAttendanceProcedure($start_cycle,$end_cycle,$weekend_date,$total_days,$month,$current_year,$prev_month_total_days,$prev_month,$prev_month_year,login_details['user_id']);
			// }
				exit();
