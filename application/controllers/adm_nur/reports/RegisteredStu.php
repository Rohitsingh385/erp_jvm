...
class RegisteredStu extends MY_Controller {
	...
	public function ReportStuData(){
		...
		$data['ReportData'] = $this->alam->selectA('nursery_adm_data','*',"date(created_at)='$val' AND f_code='Ok'");
		$data['nur_reg_user'] = $this->alam->selectA('nur_reg_user','*',"id='$user_session_id'");
		$this->load->view('nur_adm/admin/loadstartDateReport',$data);
	}
	...
	public function ReportStuDateRange(){
		...
		$data['ReportData'] = $this->alam->selectA('nursery_adm_data','*',"date(created_at) BETWEEN '$start_date' AND '$end_date' AND f_code='Ok'");
		$data['nur_reg_user'] = $this->alam->selectA('nur_reg_user','*',"id='$user_session_id'");
		$this->load->view('nur_adm/admin/loadEndDateReportWithDateRange',$data);
	}
	...
	public function ReportStuDateRangeStatus(){
		...
		$data['ReportData'] = $this->alam->selectA('nursery_adm_data','*',"date(created_at) BETWEEN '$start_date' AND '$end_date' AND verified_status='$verified_status' AND f_code='Ok'");
		$data['nur_reg_user'] = $this->alam->selectA('nur_reg_user','*',"id='$user_session_id'");
		$this->load->view('nur_adm/admin/loadReportWithStatus',$data);
	}
}
