...
class FailedTransReport extends MY_Controller {
	...
	public function index(){
		...
		$this->nurseryAdmissionAdminTemplate('nur_adm/admin/transFailedReportData',$data);
	}
	...
	public function ReportStuData(){
		...
		$this->load->view('nur_adm/admin/transFailedloadstartDateReport',$data);
	}
	...
	public function ReportStuDateRange(){
		...
		$this->load->view('nur_adm/admin/transFailedloadEndDateReportWithDateRange',$data);
	}
