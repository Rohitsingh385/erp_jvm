...
class NotAttempted extends MY_Controller {
	...
	public function index(){
		...
		$this->nurseryAdmissionAdminTemplate('nur_adm/admin/notAttemptedReportData',$data);
	}
	...
	public function ReportStuData(){
		...
		$this->load->view('nur_adm/admin/notAttemptedloadstartDateReport',$data);
	}
	...
	public function ReportStuDateRange(){
		...
		$this->load->view('nur_adm/admin/notAttemptedloadEndDateReportWithDateRange',$data);
	}
