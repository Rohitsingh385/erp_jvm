...
class Atompay{
  ...
  private function writeLog($data){
    ...
    $fp = fopen("uploads/log/".$fileName, 'a+');
  ...
  // CREATE
  public function atom_request($transId, $env, $login, $pwd, $product, $amt, $curr, $redirect_url, $regid, $name, $email, $mobile, $address, $acc, $reqHashKey){
    ...
    $this->setCustomerAccount($acc);
    $this->setReqHashKey($reqHashKey);
    $url = $this->getPGUrl();
    header("Location: ".$url);
    //exit();
  }
