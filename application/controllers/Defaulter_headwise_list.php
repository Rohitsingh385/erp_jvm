...
class Defaulter_headwise_list extends MY_Controller{
	...
	public function defaulter_classwise()
	{
		...
		$student = $this->dbcon->select('student','ADM_NO,FIRST_NM,ROLL_NO,APR_FEE,MAY_FEE,JUNE_FEE,JULY_FEE,AUG_FEE,SEP_FEE,OCT_FEE,NOV_FEE,DEC_FEE,JAN_FEE,FEB_FEE,MAR_FEE,DISP_CLASS,DISP_SEC',"Student_Status='ACTIVE' AND DISP_CLASS='$classs' AND DISP_SEC='$sec'");
