...
class EmployeedeductionVPF extends MY_Controller {
	...
	public function index(){
		...
		$data['employeeList'] = $this->attendance->getEmployeeDataForDeductionBulkUpdationVPF();
        // echo "<pre>";
        // print_r($data);die;
		$this->render_template('bulk_updation/employeeDeductionVPF_bulk',$data);
	}
	...
	public function updateDeduction()
	{
		...
		if($checkExist == true)
		{
            ...
            $this->sumit->update('employee',$data_emp,"id='$emp_id'");
		}
		else
		{
