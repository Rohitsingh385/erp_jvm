...
class EmployeedeductionTDS extends MY_Controller {
	...
	public function index(){
		...
		$data['employeeList'] = $this->attendance->getEmployeeDataForDeductionBulkUpdationTDS();
        // echo "<pre>";
        // print_r($data);die;
		$this->render_template('bulk_updation/employeeDeductionTDS_bulk',$data);
	}
