...
$row++;
	...
	$sql=$this->db->query("UPDATE student_tc SET left_school = '$lstschdate' where stu_class=$hclassr and session_year='$syear'");
...
function update_passedyear(){
	...
	$sql=$this->db->query("UPDATE student_tc SET pass_year = '$passingyear' where stu_class=$hclassr and session_year='$syear'");
	// $sql = $this->db->update('student_tc','left_school='.$lstdate.'','stu_class='.$hclassr.' and session_year='.$syear.'');
...
function update_issuedate(){
	...
	$sql=$this->db->query("UPDATE student_tc SET cer_issue_date = '$certissuedate' where stu_class=$hclassr and session_year='$syear'");
	// $sql = $this->db->update('student_tc','left_school='.$lstdate.'','stu_class='.$hclassr.' and session_year='.$syear.'');
