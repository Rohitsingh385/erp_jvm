...
class Studentresult extends MY_Controller{
	...
	//$this->Parent_templete('parents_dashboard/result/studentresult_view',$data);
			...
			$adm=str_replace("-","/",$adm);
		$ddt=$this->alam->selectA("student",'ADM_NO,FIRST_NM,MIDDLE_NM,TITLE_NM,FATHER_NM,MOTHER_NM,ROLL_NO,CLASS,SEC,DISP_CLASS,DISP_SEC',"ADM_NO='$adm' and t1_report_card_status=1");
		$class=$ddt[0]['CLASS'];
		$SEC=$ddt[0]['SEC'];
