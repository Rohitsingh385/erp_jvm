...
class Payment extends My_controller{
	...
	public function index(){
		...
		$transLog = array(
			'ClientCode' => generate_session['id']."/2021",
	...
	public function redirect_payment_call_back(){
		...
		if(is_array($paymentResponse)){
			...
			if(strtolower($paymentResponse['f_code']) == 'ok'){
				...
				$this->alam->update("three_adm_data",$updData,"transaction_id='$tr_id'");
				...
				$data['allData'] = $this->alam->selectA('three_adm_data','*',"transaction_id='$tr_id'");
