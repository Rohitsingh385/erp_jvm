...
class Employee extends MY_Controller {
	...
	public function createProcess()
	{
		...
		if($emp_id == '')
		{
			...
			if (str_contains($emp_id, 'EMP')) {
				$len = strlen($emp_id);
				if ($len == 7) {
				} else {
					if ($len == 1) {
						$emp_id = 'EMP000' . $emp_id;
					} elseif ($len == 2) {
						$emp_id = 'EMP00' . $emp_id;
					} elseif ($len == 3) {
						$emp_id = 'EMP0' . $emp_id;
	...
	public function update($id = null)
	{
		...
		if($session_data['ROLE_ID'] == 4 || $session_data['ROLE_ID'] == 1 || $session_data['ROLE_ID'] == 10 || $session_data['ROLE_ID'] == 14)
		{
	...
	public function checkEmpID_new()
	{
