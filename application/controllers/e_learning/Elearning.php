...
class Elearning extends MY_Controller {
	...
	public function index(){
		...
		$data['subjData']    = $this->alam->selectA('class_section_wise_subject_allocation','Class_No,section_no,subject_code,(SELECT SubName FROM subjects WHERE SubCode=class_section_wise_subject_allocation.subject_code)subject',"Class_No='$class' AND section_no='$sec' and applicable_exam = '1' order by sorting_no");
	...
	public function getChapterTopic(){
		...
		$chapterData = $this->alam->selectA('chaptertopicmaster','id,chapter',"classes='$cls' AND sec='$sec'");
		$ret = '';
