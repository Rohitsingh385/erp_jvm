...
class Inbox extends MY_Controller {
	...
	public function index(){
		...
		$data['chatData']   = $this->alam->selectA('chat_msg','sender_id,(SELECT FIRST_NM from student WHERE ADM_NO=chat_msg.sender_id)firstnm,count(id)cnt,sender_date',"receiver_id = '$user_id' AND read_status = 'N' AND sender_user = 'P' GROUP BY sender_id order by sender_date DESC");
