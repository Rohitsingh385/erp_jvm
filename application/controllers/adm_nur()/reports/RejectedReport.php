...
class RejectedReport extends MY_Controller {
	...
	public function index(){
		...
		$data['verifiedData'] = $this->alam->selectA('nursery_adm_data','*,(select CAT_DESC from category where CAT_CODE=nursery_adm_data.category)catnm,(select Rname from religion where RNo=nursery_adm_data.religion)religionnm',"f_code='Ok' AND verified_status='2'");
		$this->nurseryAdmissionAdminTemplate('adm_three/admin/rejectedList',$data);
	}
}
