...
class Notice_Model extends CI_model{
	...
	public function getElearningDetails($where){
		$query = $this->db->query("SELECT *,(SELECT date FROM e_learning WHERE id=naw.elearning_tbl_id)homework_date,(SELECT lock_topic FROM e_learning WHERE id=naw.elearning_tbl_id)lock_topic,(SELECT chapter FROM chaptertopicmaster WHERE id=naw.elearning_tbl_id)chapternm,(SELECT topic FROM e_learning WHERE id=naw.elearning_tbl_id)topic,(SELECT id FROM e_learning WHERE id=naw.elearning_tbl_id)elearning_id,(SELECT subject FROM e_learning WHERE id=naw.elearning_tbl_id)subject,(SELECT class FROM e_learning WHERE id=naw.elearning_tbl_id)class,(SELECT sec FROM e_learning WHERE id=naw.elearning_tbl_id)sec,(SELECT remarks FROM e_learning WHERE id=naw.elearning_tbl_id)remarks,(SELECT img FROM e_learning WHERE id=naw.elearning_tbl_id)img,(SELECT subject FROM e_learning WHERE id=naw.elearning_tbl_id)subjectCode,(select SubName from subjects where SubCode=subjectCode)subjnm,(SELECT homework_date FROM e_learning WHERE id=naw.elearning_tbl_id)hwDate FROM `e_learning_adm_wise` naw WHERE $where");
		return $query->result_array();
	}
